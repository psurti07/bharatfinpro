	...
	public function addUser(){
		...
		if($isuser == 0) {
			...
			if($userid > 0) {
				...
				$applicationid = $this->Manage_Plan_User_Model->addapplication($data2);
				...
				$membershipid = $this->Manage_Plan_User_Model->membershiporder($data4);
	...
	public function converttocustomer(){
		...
		if(isset($_REQUEST['userid'])) {
			...
			if($membershipid != 0){
				...
				$applicationid = $this->Manage_Plan_User_Model->updateapplication($_REQUEST['applicationid'], $data2);
				...
				$response2 = $this->Manage_Plan_User_Model->updateuserprofile($userdata->id, $data2);
