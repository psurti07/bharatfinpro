...
//  Dashboard
define('PG_DIGITAL_PL', '#');
define('PG_DIGITAL_BL', '#');
define('PG_PLAN_PL', '#');
define('PG_PLAN_BL', '#');
define('PG_CARD_OFFER', '#'); // fail payment page
define('PG_SPECIAL_OFFER', '#');
define('PG_BUMPER_OFFER', '#');
define('PG_STAR_OFFER', '#');
define('PG_PRIME_OFFER', '#');
define('PG_MEGA_OFFER', '#');
define('PG_SUPER_OFFER', '#'); // product offer page
define('PG_QUICK_OFFER', '#'); // product pffer page
