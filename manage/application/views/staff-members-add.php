...
<div class="content-header row">
    ...
    <div class="content-header-right btn-group-sm text-right col-md-4 col-12 mb-1">
        <a href="<?php echo site_url('site/stafflist'); ?>" target="_self" class="btn btn-outline-primary"><i
                class="la la-list-ol"></i> Staff List</a>
    </div>
</div>
                            ...
                            <div class="form-body">
                                <div class="form-group btn-group-toggle" data-toggle="buttons">
                                    <div class="btn-group">
                                        <label class="btn btn-outline-dark">
                                            <input type="radio" name="staffrole" value="0" autocomplete="off"><i
                                                class="icon-user"></i> Admin
                                        </label>
                                        <label class="btn btn-outline-dark active">
                                            <input type="radio" name="staffrole" value="1" autocomplete="off" checked><i
                                                class="icon-user"></i> Employee
                                        </label>
                                        <label class="btn btn-outline-dark">
                                            <input type="radio" name="staffrole" value="2" autocomplete="off"><i
                                                class="icon-user"></i> ACCOUNTANT
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mobile" id="mobile" class="form-control"
                                        aria-required="true" required inputmode="numeric"
                                        data-validation-regex-regex="^[6789]\d{9}$" maxlength="10">
                                    <div class="help-block font-small-3"></div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" id="generate-btn" class="btn btn-light"
                                        onclick="return generatepassword();">Generate</button>
                                </div>

                            </div>

                            <div class="form-actions text-right">
                                <a href="<?php echo site_url('site/stafflist'); ?>"
                                    class="btn btn-outline-light">CANCEL</a>
                                <button type="submit" id="submit-btn" class="btn btn-success btn-min-width">CREATE
                                    ACCOUNT</button>
                            </div>
                            <?php echo form_close(); ?>
