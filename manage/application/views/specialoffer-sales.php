...
<script type="text/javascript">   
  window.onload = function(){
      ...
      document.getElementById("1291").className += " active";
  }
</script>
  ...
  <div class="content-header row">
	  <div class="content-header-left col-md-6 col-12 mb-1">
		...
		<div class="content-header-right col-md-6 col-12 mb-1">
		  <?php echo form_open('enquiry/specialoffer', array('id'=>'filterForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                    ...
                    <tbody>
                      ...
                      <?php
                        if(count($saleslist)) {
                            ...
                            if($row->isCustomer == 1) {
                              echo "<td class='text-center'>".anchor("enquiry/offerstatus/2/{$row->isCustomer}/{$row->id}",'Customer','class="btn btn-icon btn-outline-primary btn-sm"')."</td>";
                            }
                            else {
                              echo "<td class='text-center'>".anchor("enquiry/offerstatus/2/{$row->isCustomer}/{$row->id}",'Lead','class="btn btn-icon btn-outline-warning btn-sm"')."</td>";
                            }
