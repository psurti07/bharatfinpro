...
<div class="content-body">
    ...
    <div class="row">
        <div class="col-12">
            <h2 class="text-bold-600 text-center">Webinar Customer Statistics - <?php echo  date('d M, Y'); ?></h2>
            <hr />
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <h2 class="text-bold-600 text-center">Onboard Customer Statistics -
                <?php echo  date('d M, Y', strtotime('-1 day')); ?></h2>
            <hr />
        </div>
    </div>
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response['success'] == true) {
                document.getElementById('webinarleadsell').innerHTML = response['statistics'][
                    'webinarleadsell'
                ];
                document.getElementById('webinarsellall').innerHTML = response['statistics'][
                    'webinarsellall'
                ];
                document.getElementById('onboardleadsell').innerHTML = response['statistics'][
                    'onboardleadsell'
                ];
                document.getElementById('onboardsellall').innerHTML = response['statistics'][
                    'onboardsellall'
                ];
