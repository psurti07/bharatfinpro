                          ...
                          <div class="form-group btn-group-toggle" data-toggle="buttons">
                            <div class="btn-group">
                              <label class="btn btn-outline-primary <?php echo ($linkdetails->loantype == 11) ? 'active' : ''; ?>">
                                <input type="radio" name="loantype" value="11" autocomplete="off" <?php echo ($linkdetails->id == 11) ? 'checked' : ''; ?>>Digital Personal Loan
                              </label>
                              <label class="btn btn-outline-primary <?php echo ($linkdetails->loantype == 12) ? 'active' : ''; ?>">
                                <input type="radio" name="loantype" value="12" autocomplete="off" <?php echo ($linkdetails->id == 12) ? 'checked' : ''; ?>>Digital Business Loan
                              </label>
                            </div>
                          </div>
