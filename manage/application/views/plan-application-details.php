              ...
              <div class="card-content collapse show">
                <div class="card-body">
                    <dl class="row">
                      ...
                      <dt class="col-md-8"><?php echo anchor("plan/userdetails/{$appdetails->userid}",$appdetails->fullname,'class="text-capitalize"'); ?></dt>
                    </dl>
                    <hr/>
                    ...
                    <dl class="row">
                      ...
                      <dt class="col-md-8"><?php 
                        if($appdetails->loantype == 21) {
                          echo 'Personal Loan';
                        } else if($appdetails->loantype == 22) {
                          echo 'Business Loan';
                        }
                      ?></dt>
                    </dl>
                ...
                <?php 
                  switch($appdetails->status) {
                      case "6":
                        ...
                        echo "<a href='".site_url('planloan/appstatusForm/'.$appdetails->id)."' class='btn btn-primary mr-1'>Add Status</a>";

                        echo "<a href='".site_url('planloan/applicationstatus/2/'.$appdetails->id)."' class='btn btn-success mr-1'>Approve Application</a>";
                      ...
                      case "5":
                        ...
                        echo "<a href='".site_url('planloan/applicationstatus/3/'.$appdetails->id)."' class='btn btn-danger mr-1'>Reject Application</a>";

                        echo "<a href='".site_url('planloan/applicationstatus/4/'.$appdetails->id)."' class='btn btn-warning mr-1'>Query Process</a>";

                        echo "<a href='".site_url('planloan/applicationstatus/6/'.$appdetails->id)."' class='btn btn-warning mr-1'>Customer Decline</a>";
                      break;
                      ...
                      case "3":
                        ...
                        echo "<a href='".site_url('planloan/applicationstatus/5/'.$appdetails->id)."' class='btn btn-info mr-1'>Reopen Application</a>";

                        echo "<a href='".site_url('planloan/applicationstatus/2/'.$appdetails->id)."' class='btn btn-success mr-1'>Re-approve Application</a>";
                          ...
                          foreach ($statuslist as $row) {
                            ...
                            echo "<td>";
                              ...
                              if($row->sanction_letter != ""){
                                ...
                                echo anchor("planloan/downloadfile/{$appdetails->id}/{$row->sanction_letter}",'<i class="la la-download"></i> Download','class="btn btn-icon btn-outline-dark btn-sm" target="_blank"');
                              }
                            echo "</td>";
                            
                            echo "<td class='text-center' width='50'>".anchor("planloan/deleteappstatus/{$row->id}/{$appdetails->id}",'<i class="la la-trash"></i>','class="btn btn-icon btn-outline-danger btn-sm"')."</td>";
