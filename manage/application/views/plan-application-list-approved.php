...
window.onload = function() {
    ...
    document.getElementById("1132").className += " active";
}
</script>

<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-1">
        <h1 class="content-header-title text-uppercase">Loan Application List - <strong
                class="text-success">Approved</strong></h1>
    </div>

    <div class="content-header-right col-md-6 col-12 mb-1">
        <?php echo form_open('planloan/approvehistory', array('id' => 'filterForm', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                ...
                <div class="card">
                  ...
                  if (count($applicationlist)) {
                    ...
                    foreach ($applicationlist as $row) {
                      ...
                      echo "<td class='text-center' width='50'>" . anchor("planloan/appdetails/{$row->id}", '<i class="la la-info"></i>', 'class="btn btn-icon btn-outline-dark btn-sm"') . "</td>";
