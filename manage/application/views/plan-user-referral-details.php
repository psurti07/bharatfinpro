                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-md-8">
                                    <a href="<?php echo site_url('plan/userdetails/' . $referraldetails['refferaldetails']->id); ?>"
                                        class="text-capitalize" target="_blank">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <dl class="row">
                                <dd class="col-md-4">Fullname :</dd>
                                <dt class="col-md-8">
                                    <a href="<?php echo site_url('plan/userdetails/' . $referraldetails['customerdetails']->id); ?>"
                                        class="text-capitalize" target="_blank">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-md-8"><?php echo displayDate($referraldetails['usertree']->rec_date); ?>
                                </dt>
                            </dl>
                            <hr />
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-md-8">
                                    <?php echo formatePriceIndia($referraldetails['orderdetails']->amount); ?></dt>
                            </dl>
                            <hr />
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-md-8">
                                    <?php echo formatePriceIndia($referraldetails['orderdetails']->amount * 0.35); ?>
                                </dt>
                            </dl>
                            <hr />
              ...
              if ($referraldetails['usertree']->payout == 1) {
                ...
                $payinvoice = anchor("plan/referralinvoice/{$referraldetails['usertree']->id}", '<i class="la la-print"></i>', 'class="btn btn-icon btn-outline-dark btn-sm" target="_blank"');
          ...
          if ($referraldetails['usertree']->payout == 0) {
            echo anchor("plan/payoutstatus/1/{$referraldetails['usertree']->id}", 'PAYOUT APPROVED', 'class="btn btn-icon btn-success"');
            echo anchor("plan/payoutstatus/2/{$referraldetails['usertree']->id}", 'PAYOUT REJECT', 'class="btn btn-icon btn-danger"');
          ...
          ?>
                ...
                <div class="pt-2">
                    <?php echo form_open_multipart('plan/addRemarks', array('id' => 'submitForm', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
                    <input type="hidden" name="treeid" id="treeid"
                        value="<?php echo $referraldetails['usertree']->id; ?>">
                    ...
                    <fieldset>
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="submit" id="submit-btn" class="btn btn-primary bg-info border-info"><i
