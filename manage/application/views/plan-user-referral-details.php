              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    ...
                    <dl class="row">
                      ...
                      <dt class="col-md-8">
                        <a href="<?php echo site_url('plan/userdetails/'.$referraldetails['refferaldetails']->id); ?>" class="text-capitalize" target="_blank">
              ...
              <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    ...
                    <dl class="row">
                      <dd class="col-md-4">Fullname :</dd>
                      <dt class="col-md-8">
                        <a href="<?php echo site_url('plan/userdetails/'.$referraldetails['customerdetails']->id); ?>" class="text-capitalize" target="_blank">
