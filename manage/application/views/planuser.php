...
<script type="text/javascript">   
  ...
  <div class="content-header row">
	  <div class="content-header-left col-md-6 col-12 mb-1">
	    <h1 class="content-header-title text-uppercase">Plan Customers</h1>
	  </div>

		<div class="content-header-right col-md-6 col-12 mb-1">
		  <?php echo form_open('plan', array('id'=>'filterForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                      ...
                      <?php
                        if(count($userlist)) {
                            ...
                            echo "<td>".htmlentities($row->state)."</td>";
                        		echo "<td class='text-center' width='50'>".anchor("plan/userdetails/{$row->id}",'<i class="la la-info"></i>','class="btn btn-icon btn-outline-dark btn-sm"')."</td>";
