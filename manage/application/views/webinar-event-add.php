                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="datetime-local" name="eventdate" id="eventdate"
                                            class="form-control" value="<?php echo date('Y-m-d H:i:s'); ?>">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="event_mentor">Program Mentor Name <span
                                            class="required">*</span></label>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="file" name="event_image" ID="event_image" class="form-control" required
                                        data-validation-required-message="event image is required" accept="image/*">
                                    <div class="help-block font-small-3"></div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="community_link" id="community_link" aria-required="true"
                                        class="form-control">
                                    <div class="help-block font-small-3"></div>
                                </div>
                            </div>
