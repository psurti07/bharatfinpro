...
window.onload = function() {
    document.getElementById("119").className += " active";
    document.getElementById("1191").className += " active";
}
</script>
...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-1">
        <?php echo form_open('enquiry/cardoffer', array('id' => 'filterForm', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                ...
                <div class="card">
                  ...
                  if (count($saleslist)) {
                    ...
                    foreach ($saleslist as $row) {
                      ...
                      if ($row->isCustomer == 1) {
                        echo "<td class='text-center'>" . anchor("enquiry/offerstatus/1/{$row->isCustomer}/{$row->id}", 'Customer', 'class="btn btn-icon btn-outline-primary btn-sm"') . "</td>";
                      } else {
                        echo "<td class='text-center'>" . anchor("enquiry/offerstatus/1/{$row->isCustomer}/{$row->id}", 'Lead', 'class="btn btn-icon btn-outline-warning btn-sm"') . "</td>";
                      }
