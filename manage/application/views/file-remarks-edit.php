...
<div class="content-header row">
    ...
    <div class="content-header-right btn-group-sm text-right col-md-4 col-12">
        <a href="<?php echo site_url('site/fileremarks'); ?>" target="_self" class="btn btn-outline-primary"><i
                class="la la-list-ol"></i> Remarks List</a>
    </div>
</div>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="statusid" id="statusid" data-placeholder="Select Status"
                                            class="select2 form-control" required
                                            data-validation-required-message="Status is required">
                      ...
                      ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="title" class="form-control"
                                            value="<?php echo $remarkdetails->title; ?>" required
                                            data-validation-required-message="Remark title is required">
                                        <div class="help-block font-small-3"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="remarks" class="form-control" required
                                            data-validation-required-message="Remark content is required"
                                            rows="10"><?php echo $remarkdetails->remarks; ?></textarea>
                                        <div class="help-block font-small-3"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-actions text-right">
                                <a href="<?php echo site_url('site/fileremarks'); ?>"
