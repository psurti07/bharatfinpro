...
<script type="text/javascript">   
  ...
  <div class="content-body">
	<div class="row">
		<div class="col-12">
	      <h2 class="text-bold-600 text-center">Digital Application Statistics - <?php echo date('d M, Y'); ?></h2><hr/>
	  	</div>
	</div>
	...
	<div class="row">
		<div class="col-12">
	      <h2 class="text-bold-600 text-center">Plan Application Statistics - <?php echo date('d M, Y'); ?></h2><hr/>
	  	</div>
	</div>
...
function applicationdata(){
      ...
      beforeSend:function(){
          ...
          document.getElementById('oldapplication').innerHTML = "<i class='la la-spinner spinner'></i>";
			/* for plan */	
		  document.getElementById('plan_userapplication').innerHTML = "<i class='la la-spinner spinner'></i>";
          document.getElementById('plan_reapplyapplication').innerHTML = "<i class='la la-spinner spinner'></i>";
          document.getElementById('plan_oldapplication').innerHTML = "<i class='la la-spinner spinner'></i>";
      ...
      success: function(response) {
          if(response['success'] == true) {
			...
			/*for plan */
			document.getElementById('plan_userapplication').innerHTML = response['statistics']['plan_userapplication'];
            document.getElementById('plan_reapplyapplication').innerHTML = response['statistics']['plan_reapplyapplication'];
            document.getElementById('plan_oldapplication').innerHTML = response['statistics']['plan_oldapplication'];
