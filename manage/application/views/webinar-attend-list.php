                    ...
                    foreach ($attenddetaillist as $row) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url('webinar/attand_webinar/' . $row->webinar_id . '/' . $row->id) ?>"
                                                class="btn btn-icon btn-outline-danger btn-sm">Not Attand</a>
                                            <?php } else if ($row->isAttend == 1) { ?>
                                            <a href="<?php echo base_url('webinar/attand_webinar/' . $row->webinar_id . '/' . $row->id) ?>"
                                                class="btn btn-icon btn-outline-success btn-sm"> Attand</a>
                                            <?php } ?>
