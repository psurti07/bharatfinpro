...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-1">
        <?php echo form_open('plan/referral', array('id' => 'filterForm', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                ...
                <div class="card">
                  ...
                  if (count($reflist)) {
                    ...
                    foreach ($reflist as $row) {
                      ...
                      echo "<td>" . anchor("plan/userdetails/{$row->customerid}", $row->customer, 'class="text-capitalize"') . "</td>";
                      ...
                      echo "<td>" . anchor("plan/referrallist/{$row->referalid}", $row->referal, 'class="text-capitalize"') . "</td>";
                      ...
                      echo "<td class='text-center' width='50'>" . anchor("plan/referraldetails/{$row->id}", '<i class="la la-info"></i>', 'class="btn btn-icon btn-outline-dark btn-sm"') . "</td>";
