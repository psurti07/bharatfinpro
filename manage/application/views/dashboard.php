	...
	<div class="row">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo  ($userrole != 2) ? site_url('users/digitalleads?dt_to=' . date('Y-m-d')) : '#'; ?>">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('users/digitalleads/pl?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('users/digitalleads/bl?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('users/referral?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('loan/application?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('loan/reapplyhistory?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('sms/sentotps?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700"><?php echo ($userrole != 2) ?number_format($statestics['otpmessage'], 0) : 0; ?>
									</h3>
	...
	<div class="row">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo  ($userrole != 2) ? site_url('plan/planleads?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('plan/planleads/pl?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('plan/planleads/bl?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('plan/referral?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('planloan/application?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('planloan/reapplyhistory?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
	...
	<div class="row">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('users/membershiplist/11?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('users/membershiplist/12?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('plan/planlist/21?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('plan/planlist/22?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('enquiry/cardoffer?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('enquiry/specialoffer?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('enquiry/bumperoffer?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('enquiry/staroffer?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('enquiry/primeoffer?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('enquiry/megaoffer?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('enquiry/superoffer?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
		...
		<div class="col-xl-4 col-lg-4 col-12">
			<div class="card pull-up border-primary">
				<div class="card-content">
					<div class="card-body">
						<a href="<?php echo ($userrole != 2) ? site_url('enquiry/quickoffer?dt_to=' . date('Y-m-d')) : '#'; ?>">
							<div class="media d-flex">
								<div class="media-body text-left">
									<h3 class="text-bold-700">
