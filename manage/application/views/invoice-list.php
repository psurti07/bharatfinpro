...
<!-- Modal -->
<div class="modal text-left" id="refundamountmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17"
    aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="paymentid" id="paymentid" aria-required="true" class="form-control"
                                required />
