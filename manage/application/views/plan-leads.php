...
window.onload = function() {
    ...
    document.getElementById("1151<?php echo $loan; ?>").className += " active";
}
</script>
...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-1">
        <h1 class="content-header-title text-uppercase">
            <?php
      if ($loan == 'pl') {
        echo "Plan Personal Loan - Plan Leads";
      } else if ($loan == 'bl') {
        echo "Plan Business Loan - Plan Leads";
      } else {
        echo "Plan Loan - Plan Leads";
      }
      ?>
        </h1>
    </div>
    ...
    echo form_open('plan/planleads/' . $loan, array('id' => 'filterForm', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                ...
                <div class="card">
                  ...
                  if (count($userlist)) {
                    ...
                    foreach ($userlist as $row) {
                      ...
                      echo "<td class='text-center' width='50'>" . anchor("plan/leaddetails/{$row->id}", '<i class="la la-info"></i>', 'class="btn btn-icon btn-outline-dark btn-sm"') . "</td>";
