              ...
              <div class="card-content collapse show">
                  ...
                  <dl class="row mb-0">
                    ...
                    <dd class="col-md-9 col-12">
                      <?php echo form_open('site/updatesmssenderid', array('id'=>'filterForm3', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                          <span class="mr-2"><input name="smssenderid" type="text" class="input-sm form-control col-md-9" id="smssenderid" value="<?php echo $sitedetails['smssenderid']->option_value; ?>" style="display: inline;" /></span>
                ...
                <dl class="row mb-0">
					...
					<dd class="col-md-9 col-12">
						...
						<span class="mr-2"><input name="plansenderid" type="text" class="input-sm form-control col-md-9" id="plansenderid" value="<?php echo $sitedetails['plansmssenderid']->option_value; ?>" style="display: inline;" /></span>
						<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
						<?php echo form_close(); ?>
					</dd>
				</dl>
                ...
                <dl class="row mb-0">
                  ...
                  <dd class="col-md-9 col-12">
                    <?php echo form_open('site/updatefbdomain', array('id'=>'filterForm1', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                        <span class="mr-2"><input name="domainid" type="text" class="input-sm form-control col-md-9" id="domainid" value="<?php echo $sitedetails['fbdomainvalue']->option_value; ?>" style="display: inline;" /></span>
                        <button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
                    <?php echo form_close(); ?> 
                  </dd>
                </dl>
                ...
                <dl class="row mb-0">
                  <dt class="col-md-3 col-12">Site Welcome Model</dt>
					<dd class="col-md-9 col-12">
						...
						<a href="<?php echo site_url('site/modelstatus/' . $sitedetails['welcomemodel']->option_value); ?>" target="_self" class="btn btn-icon btn-outline-dark btn-sm"><i class="la la-rotate-left"></i></a>
					</dd>
				</dl>
                </dl>
            </div>
				...
				<div class="card-content collapse show">
					...
					<div class="card-body">			
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="wpcampaignmainplan" type="text" class="input-sm form-control col-md-9" id="wpcampaignmainplan" value="<?php echo $sitedetails['wpcampaignmainplan']->option_value; ?>" aria-colspan=""style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="wpcampaignofferplan" type="text" class="input-sm form-control col-md-9" id="wpcampaignofferplan" value="<?php echo $sitedetails['wpcampaignofferplan']->option_value; ?>" style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="wpcampaignsuccessplan" type="text" class="input-sm form-control col-md-9" id="wpcampaignsuccessplan" value="<?php echo $sitedetails['wpcampaignsuccessplan']->option_value; ?>" style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
				...
				<div class="card-content collapse show">
					...
					<div class="card-body">
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="intkt_getoffer" type="text" class="input-sm form-control col-md-9" id="intkt_getoffer" value="<?php echo $sitedetails['intekt_get_offer_name']->option_value; ?>" style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="intkt_rm_offer" type="text" class="input-sm form-control col-md-9" id="intkt_rm_offer" value="<?php echo $sitedetails['intekt_rm_offer_name']->option_value; ?>" aria-colspan=""style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="intkt_user_password" type="text" class="input-sm form-control col-md-9" id="intkt_user_password" value="<?php echo $sitedetails['intkt_userwelcomename']->option_value; ?>" style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="intkt_payment_success" type="text" class="input-sm form-control col-md-9" id="intkt_payment_success" value="<?php echo $sitedetails['intkt_payment_success']->option_value; ?>" style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
				...
				<div class="card-content collapse show">
					...
					<div class="card-body">
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="intkt_getoffer_plan" type="text" class="input-sm form-control col-md-9" id="intkt_getoffer_plan" value="<?php echo $sitedetails['intekt_get_offer_name_plan']->option_value; ?>" style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="intkt_rm_offer_plan" type="text" class="input-sm form-control col-md-9" id="intkt_rm_offer_plan" value="<?php echo $sitedetails['intekt_rm_offer_name_plan']->option_value; ?>" aria-colspan=""style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="intkt_user_password_plan" type="text" class="input-sm form-control col-md-9" id="intkt_user_password_plan" value="<?php echo $sitedetails['intkt_userwelcomename_plan']->option_value; ?>" style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
						...
						<dl class="row mb-0">
							...
							<span class="mr-2"><input name="intkt_payment_success_plan" type="text" class="input-sm form-control col-md-9" id="intkt_payment_success_plan" value="<?php echo $sitedetails['intkt_payment_success_plan']->option_value; ?>" style="display: inline;" /></span>
							<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
							<?php echo form_close(); ?>
							</dd>
						</dl>
            ...
            <div class="card-body">
				...
				<dl class="row mb-0">
					...
					<dd class="col-md-9 col-12">
						...
						<span class="mr-2"><input name="pixelidwebinar" type="text" class="input-sm form-control col-md-9" id="pixelid" value="<?php echo $sitedetails['fbpixelvaluewebinar']->option_value; ?>" style="display: inline;" /></span>
						<button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
						<?php echo form_close(); ?>
					</dd>
				</dl>
                ...
                <dl class="row mb-0">
                  ...
                  <dd class="col-md-9 col-12">
                    <?php echo form_open('site/updatefbaccesstokenwebinar', array('id' => 'filterForm2', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                      <span class="mr-2"><input name="fbaccesstokenwebinar" type="text" class="input-sm form-control col-md-9" id="fbaccesstokenwebinar" value="<?php echo $sitedetails['fbaccesstokenwebinar']->option_value; ?>" style="display: inline;" /></span>
                      <button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
                      <?php echo form_close(); ?>
                  </dd>
                </dl>
                ...
                <dl class="row mb-0">
                  ...
                  <dd class="col-md-9 col-12">
                    ...
                    <span class="mr-2"><input name="fbeventnamewebinar" type="text" class="input-sm form-control col-md-9" id="fbeventnamewebinar" value="<?php echo $sitedetails['fbeventnamewebinar']->option_value; ?>" style="display: inline;" /></span>
                    <button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
                    <?php echo form_close(); ?>
                  </dd>
                </dl>
                ...
                <dl class="row mb-0">
                  ...
                  <dd class="col-md-9 col-12">
                    ...
                    <span class="mr-2"><input name="fbeventidwebinar" type="text" class="input-sm form-control col-md-9" id="fbeventidwebinar" value="<?php echo $sitedetails['fbeventidwebinar']->option_value; ?>" style="display: inline;" /></span>
                    <button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
                    <?php echo form_close(); ?>
                  </dd>
                </dl>
            ...
            <div class="card-body">
              <dl class="row mb-0">
                ...
                <?php echo form_open('site/updatewpcampaignwebinar', array('id' => 'filterForm6', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                    <span class="mr-2"><input name="wpcampaignwebinar" type="text" class="input-sm form-control col-md-9"
                        id="wpcampaignwebinar" value="<?php echo $sitedetails['wpcampaignwebinar']->option_value; ?>"
                        style="display: inline;" /></span>
                    <button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
                    <?php echo form_close(); ?>
                </dd>
              ...
              <dl class="row mb-0">
                ...
                <dd class="col-md-9 col-12">
                  ...
                  <span class="mr-2"><input name="wpcampaignofferwebinar" type="text" class="input-sm form-control col-md-9"
                      id="wpcampaignofferwebinar" value="<?php echo $sitedetails['wpcampaignofferwebinar']->option_value; ?>"
                      style="display: inline;" /></span>
                  <button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
                  <?php echo form_close(); ?>
                </dd>
              ...
              <dl class="row mb-0">
                ...
                <dd class="col-md-9 col-12">
                  ...
                  <span class="mr-2"><input name="wpcampaignsuccesswebinar" type="text" class="input-sm form-control col-md-9"
                      id="wpcampaignsuccesswebinar" value="<?php echo $sitedetails['wpcampaignsuccesswebinar']->option_value; ?>"
                      style="display: inline;" /></span>
                  <button class="btn btn-outline-dark btn-sm" name="submit" type="submit">Update</button>
                  <?php echo form_close(); ?>
                </dd>
