...
<script type="text/javascript">   
  window.onload = function(){
      document.getElementById("113").className += " active";
  }
</script>
              ...
              <div class="card">
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <?php echo form_open_multipart('planloan/addAppstatus', array('id'=>'submitForm', 'class'=>'form-horizontal', 'enctype'=>'multipart/form-data', 'novalidate'=>'novalidate')); ?>
                        ...
                        <div class="form-body">
                          ...
                          <div class="row">
                              <div class="form-group col-md-6">
                                ...
                                <div class="controls">
                                    <select name="statusid" id="statusid" data-placeholder="Select Application Status" class="select2 form-control" onchange="return displayDiv(this.value);" required data-validation-required-message="Application status is required">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="date" name="recdate" id="datepicker" class="form-control" value="<?php echo date('Y-m-d'); ?>" max="<?php echo date('Y-m-d'); ?>" required data-validation-required-message="Status date is required" />
                                </div>
                              </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="form-group col-md-12">
                              ...
                              <div class="controls">
                                  <select name="basicSelect" id="basicSelect" data-placeholder="Select Message"
                                class="select2 form-control" onchange="return premessage(this.value);">
                        ...
                        <div class="form-actions text-right">
                          <a href="<?php echo site_url('planloan/application'); ?>" class="btn btn-outline-light">CANCEL</a>
