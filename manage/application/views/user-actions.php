...
<div class="content-header row">
    ...
    <div class="content-header-right text-right col-md-4 col-12">
        <button onclick="window.history.back();" class="btn btn-outline-dark btn-sm"><i class="la la-chevron-left"></i>
            Back</button>
    </div>
</div>
      ...
      ?>
            ...
            <div class="col-lg-9 col-md-9">
                            ...
                            <div class="form-body">
                                ...
                                <div class="text-right">
                                    <button type="submit" id="submit-btn"
                                        class="btn btn-success btn-min-width">Change</button>
                                </div>
                            </div>
              ...
              if ($userdetails->isActive == 1) {
                ...
                echo "<a href='" . site_url('users/accountstatus/0/' . $userdata['id']) . "' class='btn btn-danger btn-min-width text-white'>DEACTIVATE CUSTOMER ACCOUNT</a>";
              } else {
                echo "<a href='" . site_url('users/accountstatus/1/' . $userdata['id']) . "' class='btn btn-success btn-min-width text-white'>ACTIVATE CUSTOMER ACCOUNT</a>";
              }
              ?>
                        </div>
                    </div>
