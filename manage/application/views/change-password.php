                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="password" name="oldpassword" class="form-control" required
                                            data-validation-required-message="Old password is required">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="password" name="newpassword" class="form-control" required
                                            data-validation-required-message="New password is required" minlength="6">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="password" name="retypepassword" class="form-control" required
                                            data-validation-required-message="Retype password is required"
                                            data-validation-match-match="newpassword"
                                            data-validation-match-message="New passwrod and Retype password are not matched."
                                            minlength="6">
                                    </div>
                                </div>
                            </div>
                ...
                if (response['success'] == true) {
                    ...
                    setTimeout(function() {
                        window.location.href =
                            '<?php echo base_url("Login/logout"); ?>';
                    }, 2000);
                } else {
