			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/1'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="userregistration"><?php echo  $statistics['userregistration'] ?></h3>
			...
			<div class="card pull-up border-primary">
			  <div class="card-content">
			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/2'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="usereligibility"><?php echo  $statistics['usereligibility'] ?></h3>
			...
			<div class="card pull-up border-primary">
			  <div class="card-content">
			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/3'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="userpreapproved"><?php echo  $statistics['userpreapproved'] ?></h3>
			...
			<div class="card pull-up border-primary">
			  <div class="card-content">
			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/4'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="membershipcard"><?php echo  $statistics['membershipcard'] ?></h3>
			...
			<div class="card pull-up border-primary">
			  <div class="card-content">
			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/5'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="userverification"><?php echo  $statistics['userverification'] ?></h3>
			...
			<div class="card pull-up border-primary">
			  <div class="card-content">
			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/6'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="docverification"><?php echo  $statistics['docverification'] ?></h3>
			...
			<div class="card pull-up border-primary">
			  <div class="card-content">
			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/7'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="appinprocess"><?php echo  $statistics['appinprocess'];?></h3>
			...
			<div class="card pull-up border-primary">
			  <div class="card-content">
			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/8'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="appqueryprocess"><?php echo $statistics['appqueryprocess'] ?></h3>
			...
			<div class="card pull-up border-primary">
			  <div class="card-content">
			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/9'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="appfilereopen"><?php echo $statistics['appfilereopen'] ?></h3>
			...
			<div class="card pull-up border-primary">
			  <div class="card-content">
			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/10'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="apprejected"><?php echo $statistics['apprejected']?></h3>
			...
			<div class="card pull-up border-primary">
			  <div class="card-content">
			    ...
			    <a class="text-dark" href="<?php echo site_url('report/processstep/11'); ?>">
			      <div class="media d-flex">
			        <div class="media-body text-left">
			          <h3 class="text-bold-700" id="appapproved"><?php echo $statistics['appapproved']?></h3>
