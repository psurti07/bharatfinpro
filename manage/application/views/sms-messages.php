      ...
      <div class="modal-body">
        ...
        <div class="form-body">
          ...
          <div class="form-group">
            ...
            <div class="controls">
              <select name="smsid" id="smsid" data-placeholder="Select SMS" class="select2 form-control" required
                data-validation-required-message="SMS is required" style="width: 100%;">
          ...
          <div class="form-group">
            ...
            <div class="controls">
              <input type="text" name="mobile" id="mobile" class="form-control"  required minlength="10" maxlength="10" inputmode="numeric" data-validation-regex-regex="^[6789]\d{9}$"
