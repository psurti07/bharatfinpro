...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-1">
        <?php echo form_open('enquiry/bumperoffer', array('id' => 'filterForm', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                ...
                <div class="card">
                  ...
                  if (count($saleslist)) {
                    ...
                    foreach ($saleslist as $row) {
                      ...
                      if ($row->isCustomer == 1) {
                        echo "<td class='text-center'>" . anchor("enquiry/offerstatus/3/{$row->isCustomer}/{$row->id}", 'Customer', 'class="btn btn-icon btn-outline-success btn-sm"') . "</td>";
                      } else {
                        echo "<td class='text-center'>" . anchor("enquiry/offerstatus/3/{$row->isCustomer}/{$row->id}", 'Lead', 'class="btn btn-icon btn-outline-warning btn-sm"') . "</td>";
                      }
