                                              ...
                                              <div class="">
                                                <input type="hidden" name="schid" id="schid">
                                                  <div class="form-group row">
                                                    <label for="schedule_date" class="col-md-3">Date <span class="required">*</span></label>
                                                    <div class="col-md-9">
                                                      <input type="date" name="schedule_date" id="schedule_date" class="form-control" required value="<?php echo date('Y-m-d H:i:s'); ?>" >
                                                    </div>
                                                    <div class="help-block font-small-3"></div>
                                                  </div>

                                                  <div class="form-group row">
                                                    <label for="schedule_time" class="col-md-3">Time <span class="required">*</span></label>
                                                      <div class="col-md-9">
                                                        <select class="custom-select form-control" aria-required="true" id="schedule_time" name="schedule_time" required>
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <lable class="language" class="col-md-9"><strong>Hindi</strong> </label>
                                                    <div class="help-block font-small-3"></div>
                                                  </div>

                                                  <div class="form-group row">
                                                    <label for="remark" class="col-md-3">Remarks <span class="required">*</span></label>
                                                    <div class="col-md-9">
                                                      
                                                      <textarea name="remark" id="remark" aria-required="true" class="form-control"></textarea>
                                                    </div>
                                                    <div class="help-block font-small-3"></div>
                                                  </div>

                                                  <div class="form-group row">
                                                    <label for="status" class="col-md-3">Status <span class="required">*</span></label>
                                                      <div class="col-md-9">
                                                        <select class="custom-select form-control" aria-required="true" id="status" name="status" required>
                                                              <option value="">Select</option>
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                      <textarea name="upadte_remark" id="upadte_remark" class="form-control"></textarea>
                                                    </div>
                                                    <div class="help-block font-small-3"></div>
                                                  </div>
