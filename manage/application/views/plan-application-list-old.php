...
<script type="text/javascript">   
  window.onload = function(){
      ...
      document.getElementById("1131").className += " active";
  }
</script>
            ...
            <div class="card">
              ...
              <div class="card-header">
                <div class="heading-elements w-50">
                  <?php echo form_open('planloan/oldapplication', array('id'=>'filterForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
                      ...
                      <?php
                        if(count($applicationlist)) {
                          ...
                          foreach ($applicationlist as $row) {
                            ...
                            echo "<td>".anchor("plan/applicationlist/{$row->userid}",$row->fullname,'class="text-capitalize"')."</td>";
