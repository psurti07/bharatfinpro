...
<body class="vertical-layout vertical-menu 1-column menu-expanded bg-dark blank-page blank-page" data-open="click"
                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="col-md-4 col-10 p-0">
                            <div class="card-header bg-transparent border-0 text-center">
                                <img src="<?php echo base_url('assets/images/logo/logo-dark.png'); ?>"
