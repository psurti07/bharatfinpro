...
<script type="text/javascript">   
  ...
  <div class="content-header row">
	  <div class="content-header-left col-md-8 col-12 mb-1">
			<h1 class="content-header-title text-uppercase">Plan DND User List</h1>
	  </div>
      ...
      <a href="<?php echo base_url('assets/dndfile-sample.csv'); ?>" target="_blank" class="btn btn-outline-light"><i class="la la-download"></i> Download Sample</a>
	  </div>
	</div>
            ...
            <div class="card">
              ...
              <div class="card-header">
                <div class="heading-elements">
                    <?php echo form_open('sms/plandndlist', array('id'=>'filterForm', 'class'=>'form-horizontal', 'novalidate'=>'novalidate')); ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <?php echo form_open_multipart('sms/planuploaddndfile', array('id'=>'submitForm', 'class'=>'form-horizontal', 'enctype'=>'multipart/form-data', 'novalidate'=>'novalidate')); ?>
