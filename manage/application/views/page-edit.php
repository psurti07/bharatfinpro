...
<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-1">
        <h1 class="content-header-title text-uppercase">Page - <span
                class="text-uppercase"><?php echo $pagedetails->option_key; ?></span></h1>
    </div>
</div>
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        <textarea name="content"
                                            class="ckeditor"><?php echo $pagedetails->option_value; ?></textarea>
                                    </div>
                                </div>
                            </div>
