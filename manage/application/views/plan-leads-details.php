...
<script type="text/javascript">   
  ...
  <div class="content-header row">
      ...
      <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-keyboard="false" data-target="#convertlead"><i class="la la-retweet"></i> CONVERT TO CUSTOMER</button>
			...
			<a onclick="return confirm('Are you sure you want to delete record permanently?');" href="<?php echo site_url('plan/leaddelete/'.$userdetails['userinfo']->id); ?>" target="_self" class="btn btn-outline-danger"><i class="la la-trash"></i> Delete</a>
		</div>
	</div>
