...
window.onload = function() {
    document.getElementById("115").className += " active";
}
</script>

<div class="content-header row">
    <div class="content-header-left col-md-7 col-12 mb-1">
        <h1 class="content-header-title text-uppercase">Plan Loan Lead Details</h1>
    </div>
    ...
    <div class="content-header-right btn-group-sm text-right col-md-5 col-12">
        <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-keyboard="false"
            data-target="#convertlead"><i class="la la-retweet"></i> CONVERT TO CUSTOMER</button>

        <button onclick="window.history.back();" class="btn btn-outline-dark"><i class="la la-chevron-left"></i>
            Back</button>

        <a onclick="return confirm('Are you sure you want to delete record permanently?');"
            href="<?php echo site_url('plan/leaddelete/' . $userdetails['userinfo']->id); ?>" target="_self"
            class="btn btn-outline-danger"><i class="la la-trash"></i> Delete</a>
    </div>
</div>
                ...
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-md-8">
                                    <?php
                  if ($userdetails['userinfo']->cardtype == 22) {
                    echo "Plan Business";
                  } else {
                    echo "Plan Personal";
                  }
                  ?>
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-md-8">
                                    <?php echo DateFormatDisplay($userdetails['userinfo']->rec_date); ?></dt>
                            </dl>
                            <hr />
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-md-8">
                                    <?php echo DateFormatDisplay($userdetails['userinfo']->update_date); ?></dt>
                            </dl>
                            <hr />

                            <dl class="row">
                                <dd class="col-md-4">Name :</dd>
                                <dt class="col-md-8 text-capitalize"><?php echo $userdetails['userinfo']->fullname; ?>
                                </dt>
                            </dl>
                            <hr />
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-md-8">
                                    <?php echo formatePriceIndia($userdetails['userapplication']->loanamount); ?></dt>
                            </dl>
                            <hr />
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-md-8">
                                    <?php echo formatePriceIndia($userdetails['userapplication']->income); ?></dt>
                            </dl>
                            <hr />
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-md-8">
                                    <?php echo formatePriceIndia($userdetails['userapplication']->currentemi); ?></dt>
                            </dl>
                            <hr />
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open('plan/converttocustomer', array('id' => 'submitForm', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>

                <input type="hidden" name="userid" id="userid" value="<?php echo $userdetails['userinfo']->id; ?>">

                <input type="hidden" name="applicationid" id="applicationid"
                    value="<?php echo $userdetails['userapplication']->id; ?>">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="date" name="regdate" id="regdate" class="form-control"
                                value="<?php echo date('Y-m-d', strtotime($userdetails['userinfo']->rec_date)); ?>"
                                required>
                    ...
                    <div class="form-group">
                        <h5>Card Number</h5>
                        <div class="controls">
                            <input type="text" name="cardnumber" id="cardnumber" class="form-control" minlength="16"
                                maxlength="16" data-validation-regex-regex="[0-9]+"
                ...
                <div class="form-actions text-right pb-0">
                    ...
                    <button type="submit" id="submit-btn" class="btn btn-success btn-min-width">Create An
                        Account</button>
                </div>
                <?php echo form_close(); ?>
            </div>
...
$(document).ready(function() {
    ...
    $('#submitForm').on('submit', function(event) {
        ...
        var REDIRECTURL = "<?php echo site_url('plan/userdetails/' . $userdetails['userinfo']->id); ?>";
