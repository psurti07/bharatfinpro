...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-1">
        <?php echo form_open('users/membershiplist/' . $cardtype, array('id' => 'filterForm', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                ...
                <div class="card">
                  ...
                  if (count($membershiplist)) {
                    ...
                    foreach ($membershiplist as $row) {
                      ...
                      echo "<td>" . anchor("users/membershipcard/{$row->userid}", $row->fullname, 'class="text-capitalize"') . "</td>";
