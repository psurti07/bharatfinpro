...
<div class="content-header row">
    ...
    <div class="content-header-right btn-group-sm text-right col-md-6 col-12 mb-1">
        <a href="<?php echo site_url('banks'); ?>" target="_self" class="btn btn-outline-primary"><i
                class="la la-list-ol"></i> Banks List</a>
    </div>
</div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="bank_name" class="form-control" required
                                            data-validation-required-message="Bank name is required">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="file" name="bank_image" class="form-control" required
                                            data-validation-required-message="Bank logo is required" accept="image/*">
                                        <div class="help-block font-small-3"></div>
                                        <p class="text-muted font-small-2 mt-1">Recommended Image Size - Width: 200px,
                                            Height: 100px</p>
                                    </div>
                                </div>
