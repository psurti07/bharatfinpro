...
window.onload = function() {
    ...
    document.getElementById("1134").className += " active";
}
</script>
...
<div class="content-header row">
    ...
    <div class="content-header-right col-md-6 col-12 mb-1">
        <?php echo form_open('planloan/reapplyhistory', array('id' => 'filterForm', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
