...
<div class="content-header row">
    ...
    <div class="content-header-right btn-group-sm text-right col-md-4 col-12 mb-1">
        <a href="<?php echo site_url('banks/roipackages'); ?>" target="_self" class="btn btn-outline-warning"><i
                class="la la-list-ol"></i> Packages List</a>
    </div>
</div>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group btn-group-toggle" data-toggle="buttons">
                                    <div class="btn-group">
                                        <label
                                            class="btn btn-outline-warning <?php echo ($packagedetails->loantype == 11) ? 'active' : ''; ?>">
                                            <input type="radio" name="loantype" value="11" autocomplete="off"
                                                <?php echo ($packagedetails->id == 11) ? 'checked' : ''; ?>>Digital
                                            Personal Loan
                                        </label>
                                        <label
                                            class="btn btn-outline-warning <?php echo ($packagedetails->loantype == 12) ? 'active' : ''; ?>">
                                            <input type="radio" name="loantype" value="12" autocomplete="off"
                                                <?php echo ($packagedetails->id == 12) ? 'checked' : ''; ?>>Digital
                                            Business Loan
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="bankid" id="bankid" data-placeholder="Select Bank"
                      ...
                      ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="roi" value="<?php echo $packagedetails->roi; ?>"
                                            class="form-control" required data-validation-regex-regex="[0-9,.]+"
                                            data-validation-required-message="ROI is required">
                                        <div class="help-block font-small-3"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="termsyears"
                                            value="<?php echo $packagedetails->termsyears; ?>" class="form-control"
                                            required data-validation-regex-regex="[0-9,.]+"
                                            data-validation-required-message="Terms is required">
                                        <div class="help-block font-small-3"></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="termsmonths"
                                            value="<?php echo $packagedetails->termsmonths; ?>" class="form-control"
                                            required data-validation-required-message="Terms is required">
                                        <div class="help-block font-small-3"></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-actions text-right">
                                <a href="<?php echo site_url('banks/roipackages'); ?>"
