...
<body class="vertical-layout vertical-menu 1-column menu-expanded blank-page blank-page"
	data-open="click" data-menu="vertical-menu" data-col="1-column" style="background-color:#705e008c;">
						...
						<div class="col-lg-4 col-md-4 col-12">
							...
							<div class="card">
								<div class="card-body text-center">
									...
									<fieldset class="form-group position-relative has-icon-left">
										<input type="password" name="password" class="form-control input-lg" id="user-password"
									...
									<button type="submit" id="submit-btn" class="btn btn-dark btn-md btn-block"><i class="ft-unlock"></i>
										LOGIN</button>
