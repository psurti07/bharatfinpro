                    ...
                    <div class="card-content collapse show">
                                    ...
                                    <div class="btn-group">
                                        <label class="btn btn-outline-warning active">
                                            <input type="radio" name="loantype" value="11" autocomplete="off"
                                                checked>Digital Personal Loan
                                        </label>
                                        <label class="btn btn-outline-warning">
                                            <input type="radio" name="loantype" value="12" autocomplete="off">Digital
                                            Business Loan
                                        </label>
                                    </div>
                                </div>
                      ...
                      ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="termsyears" class="form-control" required
                                            data-validation-regex-regex="[0-9,.]+"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="termsmonths" class="form-control" required
                                            data-validation-required-message="Terms is required">
                                        <div class="help-block font-small-3"></div>
                                    </div>
                                </div>
