    ...
    <div style="font-family: Sans-serif;font-size: 10pt;color: #333333;">
        <div style="padding: 0 0.40in 0 0.55in;">
                ...
                <tbody>
                    <tr>
                        <td style="vertical-align:bottom;word-wrap: break-word;">
                            <div>
                                <label style="font-size: 10pt;line-height: 20pt;color: #817d7d;"
                                    id="tmp_billing_address_label">Bill To</label>
                                <br><strong
                                    style="line-height: 15pt;"><?php echo $invdetails['refuserinfo']->fullname; ?></strong><br>
                                <span style="line-height: 15pt;white-space: pre-wrap;"
                                    id="tmp_billing_address"><?php echo $invdetails['refuserinfo']->city . "<br/>(M) " . $invdetails['refuserinfo']->mobile . "<br/>(E) " . $invdetails['refuserinfo']->email . "<br/>Code : " . $invdetails['refuserinfo']->refcode; ?></span>
                            </div>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody id="lineitem">
                    <tr>
                        <td style="font-size: 9pt;border-bottom: 1px solid #e3e3e3;background-color: #ffffff;color: #000000;padding: 10px 0px 10px 10px;"
                            ...
                            <br>
                            <span
                                style="color: #727272;font-size: 9pt;line-height: 15pt;white-space: pre-wrap;word-wrap: break-word;"
                                id="tmp_item_description">Customer Name -
                                <?php echo $invdetails['customerinfo']->fullname; ?></span>
                            <br>
                            <span
                                style="color: #727272;font-size: 9pt;line-height: 15pt;white-space: pre-wrap;word-wrap: break-word;"
                                id="tmp_item_description">Customer Mo. -
                                <?php echo $invdetails['customerinfo']->mobile; ?></span>
                        </td>
                        ...
                        <td style="font-size: 9pt;border-bottom: 1px solid #e3e3e3;background-color: #ffffff;color: #000000;text-align:right;padding: 10px 10px 10px 5px;word-wrap: break-word;"
                            valign="top"><?php echo formatePriceIndia($invdetails['cardinfo']->amount * 0.35); ?>
                            <br>
                        </td>
                    </tr>
                </tbody>
            ...
            <table style="width:100%;margin-top:3px;table-layout:fixed;border-spacing: 0;border-collapse: collapse;">
                <tbody>
                    <tr>
                        <td style="float:right;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:70%;"
                            align="right" valign="middle"><b>Total</b>
                        </td>
                        <td id="tmp_total"
                            style="float:right;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:30%;"
                            align="right" valign="middle"><b><span
                                    style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                <?php echo formatePriceIndia($invdetails['cardinfo']->amount * 0.35); ?></b>
                            <br>
                        </td>
                    </tr>
                </tbody>
