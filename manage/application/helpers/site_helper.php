...
$xmldataset = "<SmsQueue>
    <Account>
        ...
        <SenderId>" . SMS_SENDER_ID . "</SenderId>
        <Channel>2</Channel>
        <DCS>0</DCS>
        <FlashSms>0</FlashSms>
        <Route>1</Route>
...
/*$api_url = "http://m.onlinebusinessbazaar.in/sendsms.jsp?user=" . $obbusername . "&password=" . $obbapikey .
"&senderid=" . $obbsenderid . "&mobiles=" . $mobile . "&sms=" . $sms_text;
