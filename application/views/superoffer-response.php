                ...
                <div class="card border-2 border-secondary shadow-none">
                    <div class="card-body">
                        ...
                        <div class="m-t-30 m-b-30">
                            ...
                            <p>Your application has been successfully submitted. Our company executive call you back
                                soon!</p>

                            <a href="<?php echo site_url(); ?>" class="btn btn-primary btn-sm m-t-10 text-uppercase">Go
                                to Homepage</a>
                        </div>
                        <?php } ?>
                        <!-- END : SUCCESS -->
                        ...
                        <div class="m-t-30 m-b-30">
                            ...
                            <p>Your special membership card offer payment process has failed. Please try again. If you
                                have any questions you can contact on our customer care number.</p>

                            <a href="<?php echo site_url('quickoffer'); ?>"
                                class="btn btn-primary btn-sm m-t-10 text-uppercase">Try another payment method</a>
                        </div>
                        <?php } ?>
                        <!-- END : FAIL -->
                    </div>
