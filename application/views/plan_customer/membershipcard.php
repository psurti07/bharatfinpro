		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 text-center">
				...
				<div class="text-right">
					...
					<a href="<?php echo site_url('plan_customer/profile/invoice/'.stringCrypt($carddata->id, 'encrypt')); ?>" target="_blank" class="btn btn-light btn-reveal btn-reveal-left"><span>Invoice</span><i class="fa fa-download"></i></a>
				</div>
				...
				<div class="card process border-top-dark">
					<div class="card-body">
						...
						<p><small>(1) Apply for any loan to multiple banks (2) Providing loan assistance for 6 months (3) Get 35% referral payout as reward (4) Get loan approval within 7 business days (5) On call support to clear all doubts & query (6) Bank verification does not affect to CIBIL Score</small></p>
					</div>
				</div>
