        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 p-0 m-0">
                ...
                <div class="m-t-30 text-center">
                    ...
                    <p>Your loan application has been successfully submmited. <br />Please check your email and submit
                        required documents and company executive call you back soon!</p>
                </div>
            </div>
            <?php echo form_close();
			} ?>
