...
<section id="page-title" class="background-dark">
	<div class="container">
		<div class="page-title">
			<h4><i class="fa fa-tags"></i> Digital Personal Loan Application</h4>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row">
			...
			<?php if ($userdetails['step'] == "s1") {
				echo form_open('plan_customer/digital/userPersonalApply', array('id' => 'submitForm1', 'class' => '', 'novalidate' => 'novalidate')); ?>
				<div class="col-lg-12 col-md-12 col-sm-12 row p-0 m-0">
					...
					<input type="hidden" name="userid" value="<?php echo stringCrypt($userdetails['userid'], 'encrypt'); ?>" class="form-control"
						required>
			...
			<?php if ($userdetails['step'] == "s2") {
				echo form_open('plan_customer/digital/getpreApproval', array('id' => 'submitForm2', 'class' => '', 'novalidate' => 'novalidate')); ?>
				<div class="col-lg-12 col-md-12 col-sm-12 row p-0 m-0">
					...
					<div class="form-group col-md-12 text-center">
						<?php
						$eligibilityamt = calEligiblity($userdetails['income'], $userdetails['currentemi'], 11.5, $userdetails['loanamount']);
						?>
