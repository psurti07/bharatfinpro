        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="counter"> <span data-speed="500" data-refresh-interval="2"
                                data-to="<?php echo $statestics['personalloan']; ?>" data-from="0"
            ...
            <div class="col-lg-4 col-md-4 text-center">
                <div class="card">
                    <div class="card-body">
                        <div class="counter"> <span data-speed="500" data-refresh-interval="2"
                                data-to="<?php echo $statestics['businessloan']; ?>" data-from="0"
                                data-seperator="true"></span> </div>
        ...
        <div class="row m-t-30">
            <div class="col-md-12">
                <div class="blockquote1">
                    ...
                    <p><strong>If you are a self-employed person</strong> - Aadhar Card, Pan Card, Bank Statement of 6
                        months, Photo, Canceled Cheque, Business Proof, IT Return - 1 years / 2 years.</p>
