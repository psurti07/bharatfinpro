    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <?php echo form_open('plan_customer/dashboard/acceptlicence', array('id' => 'submitForm1', 'class' => 'form-horizontal', 'novalidate' => 'novalidate')); ?>
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" aria-required="true" name="agree" id="agree" class="custom-control-input"
                            value="1" required>
                        <label class="custom-control-label" for="agree">I accept the terms in the License
                            Agreement.</label>
