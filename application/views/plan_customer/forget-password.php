			...
			<div class="row">
				<div class="col-lg-5">
					<div class="text-center p-b-30">
						<a href="#" class="logo"> <img src="<?php echo base_url('assets/images/privylege_finance/logo-2x.png'); ?>" alt="<?php echo PROJECT_NAME; ?>" width="250"> </a>
					</div>
					<div class="center">
						<h3>Forget Password</h3>
						<?php echo form_open('plan_customer/login/sendForgetmessage', array('id'=>'submitForm1', 'class'=>'', 'novalidate'=>'novalidate')); ?>
							<div class="form-group">
								<label class="">Please enter your Mobile number you have created at registration</label>
								<input type="text" name="mobile" class="form-control" placeholder="Mobile no" aria-required="true" required minlength="10" maxlength="10" inputmode="numeric" data-validation-regex-regex="^[6789]\d{9}$"> 
							...
							<p class="text-center">Already have an account? <a href="<?php echo site_url('customer'); ?>">Log in Now</a> </p>
					</div>
				</div>
				<div class="col-lg-7">
					<img src="<?php echo base_url('assets/images/pattern/login.webp'); ?>" class="img-fluid rounded">
				</div>
			</div>
		</div>
		</section>
            ...
            $.ajax({
                ...
                success: function (response) {
                  if(response['success'] == true) {
                      ...
                      setTimeout(function() {
                         window.location.href = '<?php echo base_url("plan_customer/login"); ?>';
                      }, 2000);
                  }
                   else {
