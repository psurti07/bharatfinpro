...
<body>
			...
			<div class="card border-2 center shadow-none">
				<div class="card-body m-20 sm-m-0">
					<div class="text-center p-b-30">
						<a href="#" class="logo"> <img src="<?php echo base_url('assets/images/privylege_finance/logo-2x.png'); ?>"
					...
					<div class="row">
						<div class="center">
							...
							<?php echo form_open('plan_customer/login/validateLogin', array('id' => 'submitForm1', 'class' => '', 'novalidate' => 'novalidate')); ?>
							...
							<div class="form-group">
								<button type="submit" id="form-submit1" class="btn btn-block btn-primary btn-lg">LOGIN</button>
							</div>
							<?php echo form_close(); ?>

							<p class="small text-right"><a
									href="<?php echo site_url('plan_customer/login/forgotpassword'); ?>"><strong>Forgot your
										password?</strong></a></p>
	...
	<script src="<?php echo base_url('assets/js/validation/jqBootstrapValidation.js'); ?>"
		type="text/javascript"></script>

	<script src="<?php echo base_url('assets/plugins/validate/form-validation.js'); ?>" type="text/javascript"></script>
	<script src="<?php echo base_url('assets/plugins/validate/form-validation.min.js'); ?>"
		type="text/javascript"></script>
		...
		$(function () {
			$('#submitForm1').on('submit', function (e) {
				...
				$.ajax({
					...
					processData: false,
					beforeSend: function () {
						$('#form-submit1').html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> VERIFYING...');
						$('#form-submit1').attr('disabled', true);
					},
					success: function (response) {
						if (response['success'] == true) {
							$.notify({ message: response['message'] }, { type: 'success' });
							window.location.href = '<?php echo base_url("plan_customer/dashboard"); ?>';
						}
						else {
