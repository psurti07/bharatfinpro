			...
			<div class="col-lg-5">
				<div class="card process border-top-dark">
					<div class="card-body">
						...
						?>
		                <hr/><p class="text-info"><small>Our Customer service expert are here for you lines are open Mon – Sat 10 AM to 5 PM</small></p>
		            </div>
		        </div>
			</div>

			<div class="col-lg-7">
				<?php echo form_open('customer/support/submitrequest', array('id'=>'submitForm', 'class'=>'form-horizontal p-cb process border-top-dark', 'novalidate'=>'novalidate')); ?>
					...
					<div class="form-group">
						...
						<select name="subject" id="subject" aria-required="true" class="form-control" required>
							...
							<option value="Change Registered Email id or Mobile no">Change Registered Email id or Mobile no</option>
					...
					<div class="form-group">
						...
						<textarea name="query" id="query" rows="5" aria-required="true" class="form-control" required></textarea>
						<div class="help-block font-small-3"></div>
					</div>
