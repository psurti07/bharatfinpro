                    ...
                    <div class="card-body sm-m-0">
                        ...
                        <div class="col-12 mb-2">
                            <div class="form-group mb-0 ps-0">
                                <input type="checkbox" name="tandc" id="tandc" class="custom-control-input mb-0"
                        ...
                        <div class="col-12 mb-2">
                            ...
                            <div class="form-group m-b-0">
                                <button type="submit" id="form-submit2"
                                    class="btn btn-block btn-lg new-btn-color">VERIFY</button>
                            </div>
                            <?php echo form_close(); ?>
                            ...
                            <div class="form-group btn-group-toggle" data-toggle="buttons">
                                <div class="btn-group">
                                    <label class="btn btn-light active"> <input type="radio" name="usertype" value="0"
                                            autocomplete="off" checked /><i class="icon-briefcase"></i> Small Business
                                        Person</label>
                            ...
                            <div class="form-group m-b-0">
                                <button type="submit" id="form-submit3"
                                    class="btn btn-block btn-lg new-btn-color">PROCESS</button>
                            </div>
                            <?php echo form_close(); ?>
                            <?php } ?>
                        </div>
            ...
            <div class="col-12">
                <div class="accordion accordion-simple">
                    ...
                    <div class="ac-item">
                        ...
                        <div class="ac-content">
                            <p>Bharatfinpro provides business loan offers through top multiple banks in India that offer
                                Lowest Business Loan Interest Rates. Loan approval is subjective to the applicant's
                                documents.</p>
                        </div>
                    </div>
                    ...
                    <div class="ac-item">
                        ...
                        <div class="ac-content">
                            <p>Once your application is submitted along with your documents, it can take anywhere
                                ...
                                for the disbursement. Bharatfinpro helps to get instant loan approvals.</p>
                        </div>
                    </div>
                </div>
            </div>
