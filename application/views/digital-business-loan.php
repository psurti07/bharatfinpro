			...
			<div class="row align-items-center sm-m-t-35">
				<div class="col-lg-6 col-md-6 col-12 order-md-1 order-2 center sm-p-0">
					<div class="text-center">
						<img src="<?php echo base_url('assets/images/slider/frame-7001.png'); ?>" alt="Personal Loan" class="img-fluid m-b-20" />
					</div>
				</div>
					...
					<div class="card border-2 border-secondary shadow-none">
						<div class="card-header background-honeydew" style="border-radius: 8px 8px 0 0;">
							<div class="card-title">
								...
								<h4 class="font-weight-bold">Avail up to <span class="text-secondary">₹10,00,000</span> business loan instantly!</h4>
							</div>
						</div>
							...
							<?php if ($processstep == 'step1') { ?>
									<?php echo form_open('digital/sendotpCode',array('id' =>'submitForm1','class' => '','novalidate' => 'novalidate')); ?>	
										...
										<div class="form-group m-b-2">
											<button type="submit" id="form-submit1" class="btn btn-block btn-lg btn-primary" >APPLY NOW</button>
										</div>
										<div class="col-12 mb-2">
										<div class="form-group mb-0 ps-0">
											<input type="checkbox" name="tandc" id="tandc" class="custom-control-input mb-0" value="1"
											style="width:auto;height:auto" checked required>
											<label class="custom-control-label" for="tandc"
							...
							<?php } else if ($processstep == 'step3') { ?>
									<?php echo form_open('digital/registeredUser',array('id' =>'submitForm3','class' => '','novalidate' => 'novalidate')); ?>
											...
											<div class="form-group btn-group-toggle" data-toggle="buttons">
												<div class="btn-group">
													<label class="btn btn-light active"> <input type="radio" name="usertype" value="0" autocomplete="off" checked /><i class="icon-briefcase"></i> Small Business Person</label>
													<label class="btn btn-light"> <input type="radio" name="usertype" value="1" autocomplete="off" /><i class="icon-flag"></i> Audited Report Person
													</label>
												</div>
											</div>
				...
				<div class="accordion accordion-simple">
					<div class="ac-item">
						...
						<div class="ac-content">
							<p>Bharatfinpro offers business loans at the lowest EMIs starting from Rs.2,224.</p>
						</div>
					</div>
					...
					<div class="ac-item">
						...
						<div class="ac-content">
							<p>Bharatfinpro provides business loan offers through top multiple banks in India that offer Lowest Business Loan Interest Rates. Loan approval is subjective to the applicant's documents.</p>
						</div>
					</div>
					...
					<div class="ac-item">
						...
						<div class="ac-content">
							<p>Bharatfinpro provides a business loan if your CIBIL Score is 650 or higher.</p>
						</div>
					</div>
