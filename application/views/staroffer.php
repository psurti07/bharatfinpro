				...
				<div class="card border-2 border-secondary shadow-none">
					<div class="card-header background-honeydew" style="border-radius: 8px 8px 0 0;">
						<div class="card-title">
							<h4 class="font-weight-bold font-italic">Your Personal Loan up to <span class="text-secondary">Rs.5 Lakhs</span> is Ready To Be Processed Ahead!</h4>
						</div>
					</div>
			...
			<div class="col-lg-6 col-md-6 col-12 order-md-2 order-1 center sm-p-0">
				<div class="card border-2 border-secondary shadow-none">
					<div class="card-header background-honeydew" style="border-radius: 8px 8px 0 0;">
						...
						<?php endif; ?>
						<div class="card-title">
							<p><span class="font-weight-bold">Membership Fees</span> <span class="small font-italic">18% GST additional.</span></p>
							<?php
					...
					<div class="card-body sm-m-0">
						<?php echo form_open('loan/getstaroffer', array('id' => 'submitForm1', 'class' => 'form-transparent-grey', 'novalidate' => 'novalidate')); ?>
						...
						<div class="form-group text-left">
							<button type="submit" id="form-submit1" class="btn btn-block btn-lg new-btn-color">PROCEED TO PAY</button>
						</div>
