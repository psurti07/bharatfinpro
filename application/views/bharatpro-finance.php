...
<div class="header">
    ...
    <p class="text-light fs-5 mb-0" style="font-weight:600">From Trusted Partner NBFCs</p>
...
<div class="container">
            ...
            <div class="card text-center">
                <div class="card-header" style="border-radius: 8px 8px 0 0;">
                    <div class="card-title">
                        <h6 class="font-weight-bold">Check Personal Loan Options Up to <span
                                class="text-secondary">₹10,00,000</span></h6>
                    </div>
                </div>
            </div>
            <div class="step active">
                <?php if ($processstep == 'step1') { ?>
                    ...
                    <div class="col-lg-12 col-md-6 col-12 p-0">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Your Mobile No." id="mobile"
                                    name="mobile" required minlength="10" maxlength="10" inputmode="numeric"
                    ...
                    <div class="form-group m-b-2 d-flex justify-content-center">
                        <button type="submit" id="form-submit1" class="btn btn-block btn-lg btn-primary btn-process">APPLY
                            NOW</button>
                    </div>
                        ...
                        <div class="form-group mb-0 ps-0">
                            ...
                            <label class="custom-control-label" for="terms"
                                ...
                                and <a href="<?= base_url('privacy-policy') ?>" target="_blank"
                                    style="text-decoration: none;color:#000 !important" class="text-dark">Privacy Policy</a>
                                of
                    ...
                    <?php } else if ($processstep == 'step2') { ?>
                        ...
                        <div class="form-group m-b-0 d-flex justify-content-center">
                            <button type="submit" id="form-submit2"
                                class="btn btn-block btn-lg btn-primary w-25 btn-process">VERIFY</button>
                        </div>
                        <?php echo form_close(); ?>
                    </div>
                    <div class="step">
                    <?php } else if ($processstep == 'step3') { ?>
                        ...
                        <div class="form-group m-b-0 d-flex justify-content-center">
                            <button type="submit" id="form-submit3"
                                onclick="_tfa.push({notify: 'event', name: 'priv_lead', id: 1779022});"
                                class="btn btn-block btn-lg btn-primary w-25 btn-process">PROCESS</button>
                        </div>
                        <?php echo form_close(); ?>
    ...
    <div class="container p-t-20 p-b-20">
        <div class="col-md-12 p-0">
            ...
            <div class="carousel client-logos" data-margin="0" data-items="6" data-autoplay="true" data-items-md="6"
                data-items-sm="2" data-items-xs="2" data-arrows="false" data-dots="false">
                <?php foreach ($banklist as $row) { ?>
                    <img class="img-fluid" alt="<?php echo $row->bank_name; ?>"
                        src="<?php echo base_url('assets/images/bank/' . $row->bank_image); ?>">
                <?php } ?>
            </div>
        </div>
    </div>
    ...
    <section class="container background-titan-white p-t-20 p-b-20">
        <div class="col-md-12 p-0">
            ...
            <div class="carousel client-logos" data-margin="0" data-items="3" data-autoplay="false" data-items-md="3"
                data-items-sm="1" data-items-xs="1" data-arrows="false" data-dots="false">
        ...
        <div class="row">
            <div class="col-12 text-dark">
                <p class="mb-1"><small>Disclosure: Loan tenure ranges from a minimum of 6 months to a maximum of 60
                        months (5 years), depending on the policies and eligibility criteria of the respective lending
                        partner. The Maximum Annual Percentage Rate (APR) is 34% per annum, inclusive of applicable
                        interest rates, processing fees, and other charges. Processing fees may apply up to 2% of the
                        approved loan amount.</small></p>

                <p class="mb-1"><small>Representative Example: For a loan amount of ₹1,00,000 at an interest rate of
                        11.5% per annum for a tenure of 60 months (5 years), with a processing fee of 2% (₹2,000), the
                        approximate EMI would be ₹2,301. The total interest payable would be approximately ₹38,059, and
                        the total cost of the loan / total repayment amount would be approximately ₹1,38,059. The
                        resulting APR, including applicable charges, would be approximately 14.41%.</small></p>

                <p class="mb-1"><small>All figures provided above are illustrative, indicative, and subject to change.
                        Actual loan approval, interest rate, APR, loan amount, tenure, processing fees, charges, and
                        disbursement timelines are determined solely by the respective lending partner based on the
                        applicant's profile, credit assessment, internal policies, regulatory requirements, and
                        applicable terms and conditions.</small></p>

                <p class="mb-1"><small>Bharatfinpro Private Limited is a financial services consultancy and loan
                        facilitation platform and is not a lender. We do not provide loans, make credit decisions,
                        guarantee loan approval, or guarantee loan disbursal. Loan products are offered by authorized
                        Banks, NBFCs, and regulated financial institutions subject to their eligibility criteria and
                        approval processes.</small></p>

                <p class="mb-1"><small>The amount paid is only for the service charge. We are not lenders and do not
                        guarantee any loan approval.</small></p>
