...
<section class="reservation-form-over no-padding">
	<div class="container">
		<div class="row">
			...
			<?php echo form_open('digital/buycardDigital', array('id' => 'submitForm3', 'class' => 'p-cb', 'novalidate' => 'novalidate')); ?>
			<div class="col-lg-12 col-md-12 col-sm-12 row p-0 m-0 ">

				<div class="col-lg-6 col-md-6 col-sm-12 row p-0 m-0">
						...
						<p class="m-b-0">
							<?php if ($productdata['offeramount'] != 0) { ?>
								<span class="text-success m-r-10"><i class="fa fa-chevron-right m-r-5"></i> Offer Ending
									Soon</span>
							<?php } ?>
							<span class="text-dark m-r-10"><i class="fa fa-chevron-right m-r-5"></i> GST
								Additional</span>
						</p>
					</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 p-b-20">
					<img src="<?php echo base_url('assets/images/gallery/offer.jpeg'); ?>" alt="membership card offer"
