    ...
    <div class="main">
        <div class="container">
            ...
            <div class="top">
                ...
                <form id="form" action="<?php echo base_url() ?>Schedule_Slot/reschedule" method="post"
                    name="frmsubmit">
                    <div class="schedule">
                        <span><i class="fa fa-calendar-alt"></i>
                            <?php echo date('jS F Y', strtotime($userdata->date)); ?></span>
                        <span><i class="fa fa-clock"></i>
                            <?php echo date('h:i A', strtotime($userdata->time)); ?></span>
                    </div>
