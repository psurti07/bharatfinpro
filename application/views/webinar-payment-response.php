                        ...
                        <div class="card border-rounded border-success">
                            <div class="card-body">
                                <div class="m-t-30 m-b-30 text-center">
                                    ...
                                    <p class="small">Your registration and payment have been successfully completed. We
                                        look forward to seeing you!</p>
                                    <hr />

                                    <a href="<?php echo $community_link ?>"
                                        class="btn btn-dark btn-sm m-t-10 text-uppercase">JOIN COMMUNITY</a>
                                    <a href="<?php echo site_url(); ?>webinar"
                                        class="btn btn-dark btn-sm m-t-10 text-uppercase">BACK TO HOME</a>
                                    <br><br>
                        ...
                        <div class="card border-rounded border-danger">
                            <div class="card-body">
                                <div class="m-t-30 m-b-30 text-center">
                                    ...
                                    <hr>
                                    <a href="<?php echo site_url(); ?>webinar"
                                        class="btn btn-dark btn-sm m-t-10 m-b-50 text-uppercase">BACK TO PROCESS</a>
                                    <br><br>
                                    <p>Need help? Contact: <span class="text-success"><?php echo COMPANY_EMAIL ?></span>
                                    </p>
                                </div>
                            </div>
                        </div>
