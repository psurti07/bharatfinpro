						...
						<div class="card-body">
							<?php if ($processstep == 'step1') { ?>
									<div class="text-center">
										...
										<h2 class="font-weight-700">Get up to <span class="text-secondary">Rs.10 LAKHS</span> Personal Loan in Few Mins! </h2>
									</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-6 col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="text-center text-secondary m-b-20">NBFC Personal Loan Criteria for Salaried</h4>
						<ul class="list-icon list-icon-check list-icon-colored m-b-0">
							<li>Minimum Salary : Rs. 15,000 Monthly</li>
			...
			<div class="col-lg-6 col-md-6 col-12">
				<div class="card">
					<div class="card-body">
						<h4 class="text-center text-secondary m-b-20">NBFC Personal Loan Criteria for Self-Employed</h4>
						<ul class="list-icon list-icon-check list-icon-colored m-b-0">
