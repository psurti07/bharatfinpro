		...
		<div class="row d-flex align-items-center justify-content-center">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 row p-0 m-0 ">
				...
				<div class="form-group col-md-12 text-center text-uppercase">
					<button type="submit" id="form-submit3" class="btn new-btn-color">BUY NOW</button>
					<div id="resmessage"></div>
				</div>
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="text-center">
					<p class="m-b-0"><small>By proceeding, you agree to the <strong><a
									href="<?php echo site_url('privacy-policy'); ?>" target="_blank">Privacy
									Policy</a></strong> and <strong><a
									href="<?php echo site_url('terms-conditions'); ?>" target="_blank">Terms of
									Use</a></strong> of Prayosha Fincart</small></p>
