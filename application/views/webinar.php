                ...
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="col-lg-12 col-md-12 col-12 m-auto text-center mt-0 mb-0">
                        <div
                            ...
                            <h2 class="fw-7"> Unlock Super Success In <span class="tf-forth-color"> The Fintech Industry</span>
                            </h2>
                        ...
                        <div class="bottom-btns mb-5 mb-md-0 mb-lg-0">
                            <a href="<?php echo base_url('webinar/user-register') ?>" class="tf-btn m-auto text-uppercase px-4 py-2"> Apply Now <i class="fa fa-arrow-right ms-2"></i></a>
                        </div>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-12 col-xl-12 col-12">
                            <div
                                ...
                                <h2 class="fw-7"> Understand the Opportunity <span class="tf-forth-color"> Through Numbers</span>
                                </h2>
                    ...
                    <div class="row align-items-center justify-content-md-center">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="icons-box bg-white h-100">
                                    <div class="image mb-4">
                                        <img src="<?php echo base_url() ?>assets/webinar/icons/content-strategy.svg" alt="content-strategy"
                                            width="50">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="icons-box bg-white h-100">
                                    <div class="image mb-4">
                                        <img src="<?php echo base_url() ?>assets/webinar/icons/technical-support.svg" alt="technical-support"
                                            width="50">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="icons-box bg-white h-100">
                                    <div class="image mb-4">
                                        <img src="<?php echo base_url() ?>assets/webinar/icons/implementation.svg" alt="implementation" width="50">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="icons-box bg-white h-100">
                                    <div class="image mb-4">
                                        <img src="<?php echo base_url() ?>assets/webinar/icons/goal.svg" alt="goal" width="50">
                                    </div>
                                    <div class="content">
            ...
            <div class="numbers white-box bg-white p-3 p-md-4">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-12 ps-5 statestics-border">
                        <div class="num-card">
                            <h3 class="text-grad1"> <span class="tf-forth-color"> 45 </span> <span class="tf-forth-color">+</span> </h3>
                            <h6 class="mb-0 text-start"> Fintech Projects Delivered </h6>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12 ps-5 statestics-border">
                        <div class="num-card">
                            <h3 class="text-grad1"> <span class="tf-forth-color"> 10 </span> <span class="tf-forth-color">+</span> </h3>
                            <h6 class="mb-0 text-start"> Fintech &amp; Tech Experts </h6>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-12 ps-5">
                        <div class="num-card">
                            <h3 class="text-grad1"> <span class="tf-forth-color"> 100 </span> <span class="tf-forth-color">+</span> </h3>
                            ...
                            <div class="content">
                                <div class="title">
                                    <div class="service-icon icon-green">
                                        <img src="<?php echo base_url() ?>assets/images/workshop/icon2.webp" alt="icon" class="th-50">
                                    </div>
                                    <h5 class="mt-3"> Complete Digital Setup </h5>
                                </div>
                                <div class="info" style="font-size:14px">
                                    <p class="color-666"> Get a professionally designed website, intelligent lead funnels, CRM setup, customer workflows, and automation – all customized for your needs. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="services-card">
                            <div class="content">
                                <div class="title">
                                    <div class="service-icon icon-green">
                                        <img src="<?php echo base_url() ?>assets/images/workshop/icon1.webp" alt="icon" class="th-50">
                                    </div>
                                    <h5 class="mt-3">Expert Growth Strategies</h5>
                                </div>
                                <div class="info" style="font-size:14px">
                                    <p class="color-666"> Our team of experts will always be there to help you build a strong digital presence, increase conversions, and move towards long-term growth. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="services-card">
                            <div class="content">
                                <div class="title">
                                    <div class="service-icon icon-green">
                                        <img src="<?php echo base_url() ?>assets/images/workshop/icon3.webp" alt="icon" class="th-50">
                                    </div>
                                    <h5 class="mt-3">Complete Marketing Support</h5>
                                </div>
                                <div class="info" style="font-size:14px">
                                    <p class="color-666">From targeted campaigns to lead nurturing systems, we'll help you expand your reach, generate high-quality leads, and grow your business efficiently.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6v col-sm-6 col-12">
                        <div class="services-card">
                            <div class="content">
                                <div class="title">
                                    <div class="service-icon icon-green">
                                        <img src="<?php echo base_url() ?>assets/images/workshop/icon4.webp" alt="icon" class="th-50">
                                    </div>
                                    <h5 class="mt-3"> Ongoing Expert Guidance</h5>
                                </div>
                                <div class="info" style="font-size:14px">
                                    <p class="color-666">Get continuous support from our IT, marketing, operations, and business development teams to help you move forward with confidence and clarity.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="services-card">
                            <div class="content">
                                <div class="title">
                                    <div class="service-icon icon-green">
                                        <img src="<?php echo base_url() ?>assets/images/workshop/icon5.webp" alt="icon" class="th-50">
                                    </div>
                                    <h5 class="mt-3">Transparent &amp; Ethical Operations</h5>
                                </div>
                                <div class="info" style="font-size:14px">
                                    <p class="color-666">Clear processes, secure data handling, and compliant frameworks ensure that your customers always have a smooth and trustworthy experience.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="services-card">
                            <div class="content">
                                <div class="title">
                                    <div class="service-icon icon-green">
                                        <img src="<?php echo base_url() ?>assets/images/workshop/icon6.webp" alt="icon" class="th-50">
                                    </div>
                                    <h5 class="mt-3">Industry Training &amp; Insights</h5>
                                </div>
                                <div class="info" style="font-size:14px">
                                    <p class="color-666">Stay updated with practical knowledge, evolving market trends, and real-world industry insights to make smarter and more confident business decisions.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card radius-6">
                        ...
                        <div class="card-body">
                             <div class="content">
                                ...
                                <ul class="list-icon list-icon-arrow-circle list-icon-colored" style="font-size:13px">
                                    <li class="mb-2"> You focus on serving customers — we handle the digital heavy lifting </li>
                                    <li class="mb-2"> Complete control over your leads, data, and processes </li>
                ...
                <div class="col-lg-7 col-md-7 col-12">
                    <div class="step-info pe-lg-5">
                        <div class="step-card">
                            ...
                            <p class="mb-0 color-666">Register for the webinar and take the first step towards understanding real opportunities in the fintech industry.</p>
                        </div>
                        <div class="step-card">
                            <h5 class="mb-2">2. Attend &amp; Learn From Expert</h5>
                            <p class="mb-0 color-666">Gain valuable industry insights, understand business processes, and learn practical strategies from industry experts. </p>
                        </div>
                        <div class="step-card">
                            <h5 class="mb-2">3. Implement &amp; Reach New Heights</h5>
                            <p class="mb-0 color-666">Put your learning into action with our continuous support and take confident steps towards long-term business growth. </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5 col-12 text-center">
                    <div class="img d-inline-block">
                        <img src="<?php echo base_url() ?>assets/images/model-16.webp" alt="fintech sector" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="accordion" id="faqAccordion">
                            <div class="accordion-item">
                                ...
                                <div id="collapse1" class="accordion-collapse collapse" aria-labelledby="heading1" data-bs-parent="#faqAccordion" style="">
                                    <div class="accordion-body color-666">
                                        Yes. You do not require any prior experience. We will train you from the beginning and provide ongoing support to ensure a smooth journey. 
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapse2" class="accordion-collapse collapse" aria-labelledby="heading2" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body color-666">
                                        Not at all. Our team handles all the technical setup, tools, and support.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="heading4" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body color-666">
                                        Our expert team will always be there to guide and support you whenever needed.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading5">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapse1">
                                ...
                                <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="heading5" data-bs-parent="#faqAccordion" style="">
                                    <div class="accordion-body color-666">
                                       Yes. Our team will help you with everything, including training you on the marketing platform, developing marketing strategies, increasing conversions, and more. 
                                    </div>
                                </div>
                            </div>
                        </div>
