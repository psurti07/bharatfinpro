...
<section id="faqs">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<div class="heading-text heading-plain m-b-0 text-center">
					<h4>Personal Loan</h4>
				</div>
			</div>
					...
					<div class="ac-item">
						...
						<div class="ac-content">
							<ol>
								...
								<li>If you want to calculate loan EMI details then click on the loan calculator. Then, click on the "Apply Now" button.</li>
							</ol>
						</div>
					</div>
					...
					<div class="ac-item">
						...
						<div class="ac-content">
							<ol>
								...
								<li>If you have already registered then click on the login option</li>
								<li>If you want to calculate Business loan EMI details then click on the loan calculator. Then, click on the "Apply Now" button.</li>
							</ol>
						</div>
					</div>
			...
			<div class="col-6">
				<div class="accordion white accordion-shadow">
					...
					<div class="ac-item">
						...
						<div class="ac-content">
							<p>Just after a quick registration, you can choose the convenient Membership Card and purchase it.</p>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="ac-item">
						...
						<div class="ac-content">
							<ul>
								...
								<li>Free Expert Consultancy for 6 months.</li>
								<li>Up to 35% referral payout per membership card.</li>
							</ul>
						</div>
					</div>
				</div>
