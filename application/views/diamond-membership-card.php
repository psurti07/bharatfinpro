	...
	<div class="container">
		...
		<div class="row m-t-40">
			<div class="col-12">
				...
				<p class="text-justify">The Diamond Membership can be availed by anyone and absolutely no eligibility check is required for its purchasing. As Bharatfinpro is in solid collaborations with several leading banks and NBFCs (Non-Banking Financial Companies), you can get business loan offers from multiple banks and select the one that suits your requirements in terms of the loan amount, loan tenure, processing fees, rate of interest, loan insurance, etc. Also, there would be no influence on your CIBIL score even after several bank verifications.</p>
			</div>
		</div>
	</div>
</section>
