	...
	<div class="container">
		<div class="row">
			<div class="col-lg-7 col-md-7 col-12">
				...
				<p>Our Diamond Membership Card provides you with an Instant Business Loan of up to ₹1 Crore plus several attractive benefits.</p>
				...
				<a href="<?php echo site_url('digital/businessLoan'); ?>" class="btn btn-primary"><span>Buy Now</span></a>
			</div>

			<div class="col-lg-5 col-md-5 col-12">
				<img src="<?php echo base_url('assets/images/slider/membership-card-diamond.png'); ?>" alt="Diamond membership card" class="img-fluid rounded">
			</div>
		</div>
		...
		<div class="row m-t-40">
			<div class="col-12">
				...
				<p class="text-justify">To enable businesspersons in getting extremely fast and reliable business loan services, Prayosha Fincart's Diamond Membership Cards come with a set of fabulous benefits that will not only ease the entire loan taking process but will also make your entire loan process advantageous and exciting. Through the Diamond Membership Card, a business-owning individual can get an instant and 100% digital business loan of up to ₹1 Crore in just 40 hours and with the received loan amount, they can invest in their business and upscale it to new heights of growth and success.</p>

				<p class="text-justify">Business is something that involves risk at every stage of its functioning and financial assistance can be sought anytime. The best way to deal with this is by taking a quick business loan through the Diamond Membership Card and making the necessary payments to ensure a smooth flow of your business without any sort of hindrance. A business loan can be sought by a businessperson for purposes like maintaining and ensuring a good-enough cash flow, giving on-time payments to the suppliers/manufacturers/service providers, expanding your business by making a smart investment, surging your business prospects by exploring new opportunities that may require extra finance, bring in new young and talented resources to upscale your business graph with fresh ideas, set up an office and arrange the required infrastructure, etc. This loan can be repaid with easy EMIs within the decided loan tenure.</p>

				<p class="text-justify">The Diamond Membership can be availed by anyone and absolutely no eligibility check is required for its purchasing. As Prayosha Fincart is in solid collaborations with several leading banks and NBFCs (Non-Banking Financial Companies), you can get business loan offers from multiple banks and select the one that suits your requirements in terms of the loan amount, loan tenure, processing fees, rate of interest, loan insurance, etc. Also, there would be no influence on your CIBIL score even after several bank verifications.</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-4 m-b-20">
				...
				<p>We believe in helping you with all our efforts! Serving the same purpose, purchasing a membership card enables you to get free expert consultancy through which you will be guided towards fetching suitable business loan offers.</p>
			</div>

			<div class="col-lg-4 m-b-20">
				<h4>Get 35% Referral Payout as Reward</h4>
				<p>Besides getting business loan offers from our partnered banks, you can make a good income through easy refer and share, and you can earn up to 35% referral commission from us.</p>
			</div>

			<div class="col-lg-4 m-b-20">
				<h4>Quick Loan Approval</h4>
				<p>You can get a business loan of up to Rs.1 crore in just 40 hours! Our quick services will aid you in getting your business loan with the quick loan approval. Still, the final timeframe and loan details depend upon the concerned banks’ criteria and the customer profile.</p>
			</div>
			...
			<div class="col-lg-4 m-b-20">
				...
				<p>One of the best features of buying the Diamond Membership Card is that even after multiple bank verification, there will be no impact on the loan applicant’s CIBIL score.</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="row" data-item="post-item" data-stagger="10">
			...
			<div class="post-item border col-md-4 p-2">
				<div class="post-item-wrap">
					<div class="post-item-description background-grey">
						<h2>3. Buy Diamond Membership Card</h2><hr>
