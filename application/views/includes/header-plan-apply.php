...
<head>
	...
	<link rel="apple-touch-icon" sizes="180x180" href="<?php echo base_url('assets/images/privylege_finance/apple-icon-180x180.png'); ?>">
	<link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url('assets/images/privylege_finance/favicon-16x16.png'); ?>">
...
<!-- End Google Tag Manager (noscript) -->
	<div class="body-inner" style="background: rgb(247, 251, 255);">
		<header id="header" data-transparent="true" data-fullwidth="true" class="submenu-light header-disable-fixed bg-white">
			<div class="container-fluid">
				<div class="container">

					<div id="logo">
						<a href="#">
							<span class="logo-default"><img src="<?php echo base_url('assets/images/privylege_finance/logo-2x.png'); ?>"
