				...
				<div class="col-6 col-md-3 col-xl-2">
					...
					<div class="widget">
						...
						<ul class="list p-0">
							...
							<li><a href="https://fitzify.com/"><i
										class="fas fa-external-link-alt m-r-5"></i> Fitzify</a></li>
							...
							<li><i class="fas fa-external-link-alt m-r-5"></i><a href="<?php echo site_url('webinar'); ?>">Webinar</a></li>
...
<script src="<?php echo base_url('assets/plugins/metafizzy/infinite-scroll.min.js'); ?>"
	type="text/javascript"></script>
