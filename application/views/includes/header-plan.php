...
<head>
  ...
  <title><?php if(isset($meta->title)) { echo $meta->title; } else { echo "Personal Loan and Business Loan | Lending Finance"; } ?></title>
...
})(window,document,'script','dataLayer','GTM-MNC23NZ4');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MNC23NZ4"
    ...
    <header id="header" data-transparent="true" data-fullwidth="true" class="submenu-light header-disable-fixed">
      <div class="header-inner">
        <div class="container">
          ...
          <div id="logo"> 
            <a href="#">
              <span class="logo-default"><img src="<?php echo base_url('assets/images/lending-finance.png'); ?>" alt="<?php echo PROJECT_NAME; ?>" width="180"></span>
              <span class="logo-dark"><img src="<?php echo base_url('assets/images/lending-finance.png'); ?>" alt="<?php echo PROJECT_NAME; ?>" width="180"></span>
            </a> 
          </div>
          ...
          <div class="header-extras">
            <div class="p-dropdown">
                ...
                <ul class="p-dropdown-content">
                    <li><a href="tel:<?php echo COMPANY_MOBILE; ?>"><i class="icon-phone-call"></i><?php echo COMPANY_MOBILE; ?></a></li>
                    <li><a href="mailto:<?php echo COMPANY_EMAIL; ?>"><i class="icon-mail"></i><?php echo COMPANY_EMAIL; ?></a></li>
                </ul>
            </div>
          </div>
