						...
						<div class="card-body m-20 sm-m-0">
							...
							<?php } else if ($processstep == 'step3') { ?>
									<?php echo form_open('digital/registeredUser',array('id' =>'submitForm3','class' => '','novalidate' => 'novalidate')); ?>
											...
											<div class="form-group m-b-0">
												<button type="submit" id="form-submit3" onclick="_tfa.push({notify: 'event', name: 'lead', id: 1779022});" class="btn btn-block btn-lg new-btn-color" >PROCESS</button>
											</div>
									<?php echo form_close(); ?>
							<?php } ?>
						</div>
...
<section class="box-fancy section-fullwidth p-0">
	<div class="row text-white">
		<div class="col-lg-4 col-md-4" style="background-color: #144835;">
			...
			<h3>Personal Loan Criteria</h3>
			<p class="text-white"><strong>NBFC Personal Loan Criteria for Salaried:</strong><br/>
			...
			<p class="text-white"><strong>NBFC Personal Loan Criteria for Self-Employed:</strong><br/>
