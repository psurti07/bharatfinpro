...
<body>
    <div style="font-family: Sans-serif;font-size: 10pt;color: #333333;">
        <div style="padding: 0 0.40in 0 0.55in;">
                      ...
                      : pre-wrap;" id="tmp_org_address">3rd Floor, Plot 28, Sy. No. 123/1,<br /> Parvati Nagar Co-op.
                        ...
                        <td style="vertical-align:bottom;word-wrap:break-word;float:right;text-align:right;width:50%;">
                            ...
                            <div style="clear:both;margin-top:20px;">
                                ...
                                <br>
                                <b><?php echo 'PL_' . $invdetails['orderinfo']->id; ?></b>
                                <br><br>
                ...
                <tbody>
                    <tr>
                        <td style="vertical-align:bottom;word-wrap: break-word;">
                            <div>
                                <label style="font-size: 10pt;color: #817d7d;" id="tmp_billing_address_label">Bill
                                    To</label>
                                <br><strong><?php echo $invdetails['userinfo']->fullname; ?></strong><br>
                                <span style="white-space: pre-wrap;"
                                    id="tmp_billing_address"><?php echo $invdetails['userinfo']->city . "<br/>(M) " . $invdetails['userinfo']->mobile . "<br/>(E) " . $invdetails['userinfo']->email; ?></span>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <table style="width:100%;margin-top:20px;table-layout:fixed;border-spacing: 0;border-collapse: collapse;"
                class="pcs-itemtable" border="0" cellpadding="0" cellspacing="0">
                <thead>
                    <tr style="height:32px;">
                        <td
                            style="font-size: 10pt;color: #ffffff;background-color: #3c3d3a;padding:5px 10px 5px 10px;word-wrap: break-word;width: 60%;">
                            Item
                        </td>
                        <td style="font-size: 10pt;color: #ffffff;background-color: #3c3d3a;padding:5px 10px 5px 5px;word-wrap: break-word;width: 15%;"
                            align="right">
                            Qty
                        </td>
                        <td style="font-size: 10pt;color: #ffffff;background-color: #3c3d3a;padding:5px 10px 5px 5px;word-wrap: break-word;width:25%;"
                            align="right">
                ...
                <tbody id="lineitem">
                    <tr>
                        <td style="font-size: 9pt;border-bottom: 1px solid #e3e3e3;background-color: #ffffff;color: #000000;padding: 10px 0px 10px 10px;"
                            valign="top">
                            <span style="word-wrap: break-word;" id="tmp_item_name">Membership Card</span>
                            <br>
                            <span style="color: #727272;font-size: 9pt;white-space: pre-wrap;word-wrap: break-word;"
                                id="tmp_item_description">Card Number -
                        ...
                        <td style="font-size: 9pt;border-bottom: 1px solid #e3e3e3;background-color: #ffffff;color: #000000;text-align:right;padding: 10px 10px 10px 5px;word-wrap: break-word;"
                            valign="top"><?php echo formatePriceIndia($invdetails['orderinfo']->amount); ?>
                            <br>
                        </td>
                    </tr>
                </tbody>
            ...
            <table style="width:100%;margin-top:3px;table-layout:fixed;border-spacing: 0;border-collapse: collapse;">
                <tbody>
                    <tr>
                        <td style="font-size: 10pt;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:70%;"
                            align="right" valign="middle"><b>SUB TOTAL</b>
                        </td>
                        <td id="tmp_total"
                            style="font-size: 10pt;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:30%;"
                            align="right" valign="middle"><span
                                style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            <?php echo formatePriceIndia($invdetails['invoiceinfo']->inv_price); ?>
                            <br>
                        </td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        <td style="font-size: 10pt;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:70%;"
                            align="right" valign="middle"><b>+ 9% CGST</b>
                        </td>
                        <td id="tmp_total"
                            style="font-size: 10pt;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:30%;"
                            align="right" valign="middle"><span
                                style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            <?php echo formatePriceIndia($invdetails['invoiceinfo']->inv_cgst); ?>
                            <br>
                        </td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr>
                        <td style="font-size: 10pt;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:70%;"
                            align="right" valign="middle"><b>+ 9% SGST</b>
                        </td>
                        <td id="tmp_total"
                            style="font-size: 10pt;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:30%;"
                            align="right" valign="middle"><span
                                style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            <?php echo formatePriceIndia($invdetails['invoiceinfo']->inv_sgst); ?>
                            <br>
                        </td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr>
                        <td style="font-size: 10pt;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:70%;"
                            align="right" valign="middle"><b>+ 18% IGST</b>
                        </td>
                        <td id="tmp_total"
                            style="font-size: 10pt;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:30%;"
                            align="right" valign="middle"><span
                                style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            <?php echo formatePriceIndia($invdetails['invoiceinfo']->inv_igst); ?>
                            <br>
                        </td>
                    </tr>
                    <?php } ?>
                    <tr>
                        <td style="font-size: 10pt;border-top: 1px solid #e3e3e3;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:70%;"
                            align="right" valign="middle"><b>GRAND TOTAL</b>
                        </td>
                        <td id="tmp_total"
                            style="font-size: 10pt;border-top: 1px solid #e3e3e3;text-align:right;padding:5px 10px 5px 5px;word-wrap:break-word;width:30%;font-size:12pt;"
                            align="right" valign="middle"><b><span
                                    style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                <?php echo formatePriceIndia($invdetails['invoiceinfo']->inv_grandtotal); ?></b>
                            <br>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tr>
                        <td style="vertical-align:bottom;word-wrap:break-word;float:left;width:50%;text-align:left;">
                            ...
                            <p style="margin-top:7px;white-space: pre-wrap;word-wrap: break-word;font-size: 8pt;">
                                Payment Method: Online Payment<br>Payment Id:
                                <?php echo $invdetails['orderinfo']->paymentid; ?>
                            </p>
                ...
                <tbody>
                    <tr>
                        <td style="vertical-align:bottom;word-wrap:break-word;float:center;text-align:center;">
                            <p style="font-size:8pt;font-family:monospace;">This is Computer generated Invoice. Does not
