				...
				<div class="row">
					...
					<?php if ($docflags['profilephoto'] == 0) { ?>
						<div class="col-md-6 col-12">
							<?php echo form_open('customer/profile/uploaddocument', array('id' => 'submitForm11', 'class' => 'p-cb process border-top-dark', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
					...
					<?php if ($docflags['aadharcard'] == 0) { ?>
						<div class="col-md-6 col-12">
							<?php echo form_open('customer/profile/uploaddocument', array('id' => 'submitForm13', 'class' => 'p-cb process border-top-dark', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
					...
					<?php if ($docflags['pancard'] == 0) { ?>
						<div class="col-md-6 col-12">
							<?php echo form_open('customer/profile/uploaddocument', array('id' => 'submitForm12', 'class' => 'p-cb process border-top-dark', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
					...
					<?php if ($docflags['lightbill'] == 0) { ?>
						<div class="col-md-6 col-12">
							<?php echo form_open('customer/profile/uploaddocument', array('id' => 'submitForm15', 'class' => 'p-cb process border-top-dark', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
					...
					<?php if ($docflags['cancelcheque'] == 0) { ?>
						<div class="col-md-6 col-12">
							<?php echo form_open('customer/profile/uploaddocument', array('id' => 'submitForm14', 'class' => 'p-cb process border-top-dark', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
					...
					<?php if ($docflags['bankstatement'] == 0) { ?>
						<div class="col-md-6 col-12">
							<?php echo form_open('customer/profile/uploaddocument', array('id' => 'submitForm16', 'class' => 'p-cb process border-top-dark', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
					...
					<?php if ($profiledata->cardtype == 11) { ?>
						<?php if ($docflags['formsixteen'] == 0) { ?>
							<div class="col-md-6 col-12">
								<?php echo form_open('customer/profile/uploaddocument', array('id' => 'submitForm17', 'class' => 'p-cb process border-top-dark', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
						...
						<?php if ($docflags['salaryslip'] == 0) { ?>
							<div class="col-md-6 col-12">
								<?php echo form_open('customer/profile/uploaddocument', array('id' => 'submitForm18', 'class' => 'p-cb process border-top-dark', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
					...
					<?php if ($profiledata->cardtype == 12) { ?>
						<?php if ($docflags['businessproof'] == 0) { ?>
							<div class="col-md-6 col-12">
								<?php echo form_open('customer/profile/uploaddocument', array('id' => 'submitForm19', 'class' => 'p-cb process border-top-dark', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
						...
						<?php if ($docflags['itreturn'] == 0) { ?>
							<div class="col-md-6 col-12">
								<?php echo form_open('customer/profile/uploaddocument', array('id' => 'submitForm20', 'class' => 'p-cb process border-top-dark', 'enctype' => 'multipart/form-data', 'novalidate' => 'novalidate')); ?>
					...
					<div class="col-md-12 col-12">
						<?php echo form_open('customer/profile/documentmsg', array('id' => 'submitForm20', 'class' => 'p-cb process border-top-dark', 'novalidate' => 'novalidate')); ?>
						<input type="hidden" name="customerid" value="<?php echo stringCrypt($profiledata->id, 'encrypt'); ?>" required>
						<div class="form-group">
