		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 text-center">
				...
				<div class="text-right">
					<a href="#" id="btn-download-image" class="btn btn-light btn-reveal btn-reveal-left"><span>Membership Card</span><i class="fa fa-download"></i></a>

					<a href="<?php echo site_url('customer/profile/invoice/'.stringCrypt($carddata->id, 'encrypt')); ?>" target="_blank" class="btn btn-light btn-reveal btn-reveal-left"><span>Invoice</span><i class="fa fa-download"></i></a>
				</div>
					...
					<div class="card-body">
						...
						<div id="credit" class="credit">
							<div class="credit__front credit__part <?php echo strtolower($cardname); ?>">
								...
								<p class="credit_numer text-left text-light"><?php echo chunk_split($carddata->card_number, 4, ' '); ?></p>
							    <div class="credit__space-full text-left text-light">
							      <span class="credit__label">VALID FROM <?php echo date('d/m/Y', strtotime($carddata->registration_date)); ?> VALID TO <?php echo date('d/m/Y', strtotime($carddata->expiry_date)); ?></span>
						...
						<p><small>(1) Apply for any loan to multiple banks (2) Providing loan assistance for 3 months (3) Get 35% referral payout as reward (4) Get loan approval within 7 business days (5) On call support to clear all doubts & query (6) Bank verification does not affect to CIBIL Score</small></p>
					</div>
				</div>
