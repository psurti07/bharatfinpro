        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                ...
                <div class="text-right">
                    ...
                    <a href="<?php echo site_url('customer/profile/invoice/' . stringCrypt($carddata->id, 'encrypt')); ?>"
                ...
                <div class="card process border-top-dark">
                    <div class="card-body">
                        ...
                        <p><small>(1) Apply for any loan to multiple banks (2) Providing loan assistance for 3 months
