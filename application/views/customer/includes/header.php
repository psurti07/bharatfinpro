        ...
        <div class="side-panel-wrap">
            ...
            <div id="mainMenu" class="menu-onclick menu-vertical">
                <div class="container">
                    <nav>
                        <p class="text-center">
                            <strong><?php echo $this->session->userdata('bfp-customername'); ?></strong><br />
                            <strong><?php echo $this->session->userdata('bfp-customermobile'); ?></strong>
                        </p>
                        <hr />

                        <ul>
                            <li><a href="<?php echo site_url('customer/dashboard'); ?>"><i class="fa fa-desktop"></i>
                                    Dashboard</a></li>
                            <li><a href="<?php echo site_url('customer/profile'); ?>"><i class="fa fa-user"></i> My
                                    Profile</a></li>
                            <li><a href="<?php echo site_url('customer/profile/documents'); ?>"><i
                                        class="fa fa-file"></i> KYC Documents</a></li>
                            <li><a href="<?php echo site_url('customer/profile/mcard'); ?>"><i
                                        class="fa fa-credit-credit"></i> Membership Card</a></li>
                            <li><a href="<?php echo site_url('customer/offers'); ?>"><i class="fa fa-cube"></i> Apply
                                    Now</a></li>
              ...
              ?>
                            ...
                            <li><a href="<?php echo site_url('customer/support'); ?>"><i class="fa fa-shield-alt"></i>
                                    Support</a></li>
                            <li><a href="<?php echo site_url('customer/Login/logout'); ?>"><i
            ...
            <div class="header-inner">
                <div class="container">
                    <div class="header-extras" style="line-height: 60px;">
                        <ul>
                            <li>
                                <a id="side-panel-trigger" href="#" class="toggle-item" data-target="body"
                                    data-class="side-panel-active"> <i class="fa fa-bars"></i> <i
