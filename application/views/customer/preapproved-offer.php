        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12">
                <div class="icon-box effect center process m-t-10 m-b-10 p-10 w-100">
                    ...
                    <a href="<?php echo $row->applyurl; ?>"
                        class="btn btn-dark btn-outline  btn-reveal btn-reveal-right btn-sm m-t-20"
                        target="_blank"><span>Apply Now</span><i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
            <?php
				}
