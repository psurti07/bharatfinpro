		...
		<div class="row">
          ...
          <?php echo form_open('customer/profile/changeprofile', array('id'=>'submitForm1', 'class'=>'form-horizontal p-cb process border-top-dark', 'novalidate'=>'novalidate')); ?>
            ...
            <div class="form-group row">
                <label for="regdate" class="col-form-label col-sm-12">Registration On - <?php echo displayDate($profiledata->rec_date); ?></label>
                <label for="regdate" class="col-form-label col-sm-12">Mobile No - <?php echo $profiledata->mobile; ?></label>
            </div>
            <div class="form-group row">
                <label for="fullname" class="col-form-label col-sm-3">Name</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" aria-required="true" name="fullname" value="<?php echo $profiledata->fullname; ?>" id="fullname" required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" aria-required="true" name="emailid" value="<?php echo $profiledata->email; ?>" id="emailid" required>
                  <div class="help-block font-small-3"></div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" aria-required="true" name="city" value="<?php echo $profiledata->city; ?>" id="city" required>
                  <div class="help-block font-small-3"></div>
                </div>
            </div>
            <div class="form-group row">
          ...
          <div class="ac-item">
              ...
              <div class="ac-content">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" class="form-control" name="password" id="password-text-input" required>
                    <div class="help-block font-small-3"></div>
                  </div>
                  <div class="form-group">
                    <label for="retype-text-input" class="col-form-label">Retype Password</label>
                    <input type="password" class="form-control" name="retypepassword" id="retype-text-input" required>
                    <div class="help-block font-small-3"></div>
                  </div>
                  <div class="form-group">
	...
	$(function(){
      ...
      $('#submitForm1').on('submit', function(e) {
            ...
            $.ajax({
                ...
                processData:false,
                beforeSend: function(){
                    $('#form-submit1').html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> SUBMITTING...');
