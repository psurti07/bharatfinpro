	...
	<div class="slide" data-bg-image="<?php echo base_url('assets/images/slider/pl-page-banner.jpg'); ?>">
		<div class="container">
			<div class="slide-captions">
				...
				<a href="<?php echo site_url('digital/personalLoan'); ?>" class="btn btn-dark btn-outline"><span>Apply Now</span></a>
			</div>
		</div>
	</div>
</div>
		...
		<div class="row p-t-20">
			...
			<div class="col-lg-4 col-sm-12">
				<div class="icon-box center process w-100 p-20">
					...
					<p class="m-b-0">Get a personal loan quickly and meet your sudden monetary requirements or the planned ones.</p>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-12 m-b-20">
				...
				<ul class="list-icon list-icon-check list-icon-colored">
					...
					<li>Salary Criteria: The loan applicant's salary should be at least Rs.15000 monthly (must reflect in the bank account)</li>
		...
		<div class="row">
			<div class="col-12">
				...
				<ul class="list-icon list-icon-check list-icon-colored">
					...
					<li>Educational Pursuits : Upscale your academics and future by pursuing education in your dream institution.</li>
					<li>Buying Vehicles : You can make your favourite vehicle yours through easy finances.</li>
					<li>Medical Emergencies : Life is unpredictable! Get ready for medical expenses for timely treatment.</li>
