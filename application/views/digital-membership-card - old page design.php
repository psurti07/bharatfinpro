		...
		<div class="row p-cb">
			...
			<?php echo form_open('digital/checkoutDigital', array('id'=>'submitForm3', 'class'=>'w-100', 'novalidate'=>'novalidate')); ?>
				<div class="col-lg-12 col-md-12 col-sm-12 p-b-20 m-0 text-center">
					<h4>Congrats! Buy Membership Now To Unlock Your <strong class="text-success">Rs. <?php echo formatePriceIndia($eligibilityamt); ?></strong> Pre-Approved Loan Offer Instantly!</h4>
				</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 p-0 m-0">
					...
					<div class="row">
						<div class="col-md-6 text-center">
							<div class="p-cb">
								<div class="credit">
									<div class="credit__front credit__part <?php echo strtolower($userdetails['cardname']).'-card'; ?>">
											<div class="credit__head">
											</div>
											<p class="credit_numer text-left">**** **** **** <?php echo random_code(4); ?></p>
											<div class="credit__space-full text-left">
											<span class="credit__label">VALID FROM <?php echo date('d/m/Y'); ?> VALID TO <?php echo date('d/m/Y', strtotime('+1 years')); ?></span>
											<p class="credit__info"><?php echo $userdetails['fullname']; ?></p>
											</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<img src="<?php echo base_url('assets/images/slider/offer-img.png') ?>" alt="Offer Image" class="offer-img2" />

								<div class="form-group col-lg-12 col-md-12 col-sm-12 m-b-0 p-t-40">
