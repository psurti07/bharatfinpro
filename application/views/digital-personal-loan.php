				...
				<div class="card border-2 border-secondary shadow-none">
					<div class="card-header background-honeydew" style="border-radius: 8px 8px 0 0;">
						<div class="card-title">
							...
							<h4 class="font-weight-bold">Avail up to <span class="text-secondary">₹5,00,000</span> personal loan instantly!</h4>
						</div>
					</div>
						...
						<?php } else if ($processstep == 'step2') { ?>
								<?php echo form_open('digital/checkotpCode',array('id' =>'submitForm2','class' => '','novalidate' => 'novalidate')); ?>
									...
									<div class="form-group m-b-0">
										<button type="submit" id="form-submit2" class="btn btn-block btn-lg btn-primary" >VERIFY</button>
									</div>
								<?php echo form_close(); ?>
						<?php } else if ($processstep == 'step3') { ?>
								<?php echo form_open('digital/registeredUser',array('id' =>'submitForm3','class' => '','novalidate' => 'novalidate')); ?>
										...
										<div class="form-group btn-group-toggle" data-toggle="buttons">
											<div class="btn-group">
												<label class="btn btn-light active"> <input type="radio" name="usertype" value="0" autocomplete="off" checked /><i class="icon-briefcase"></i>
													Salaried </label>
												<label class="btn btn-light"> <input type="radio" name="usertype" value="1" autocomplete="off" /><i class="icon-flag"></i> Self Employed
												</label>
											</div>
										</div>
										...
										<div class="form-group m-b-0">
											<button type="submit" id="form-submit3" onclick="_tfa.push({notify: 'event', name: 'lead', id: 1779022});" class="btn btn-block btn-lg btn-primary" >PROCESS</button>
										</div>
								<?php echo form_close(); ?>
						<?php } ?>
					</div>
