	...
	<div class="container">
		...
		<div class="row m-t-40">
			<div class="col-12">
				...
				<p class="text-justify">Prayosha Fincart's Gold Membership Card is an innovative and the most effective way of getting personal loan offers from multiple banks and private financial institutions – in just 48 hours! Yes, when you purchase the membership card, apart from getting instant loan offers, you get eligible to avail of certain other amazing services provided by Prayosha Fincart.</p>

				<p class="text-justify">A personal loan is a very handy and convenient option when any urgent situation, demanding financial assistance, arises. Prayosha Fincart understands it and this is the foundational thought behind the Gold Membership Card. An individual can come across certain situations like – wanting money for medical emergencies, wedding funds, unplanned vacations, home renovation, academic fees, buying your own vehicle, etc. In all such instances of urgent money need, you can easily get a personal loan of up to ₹10 Lakhs in just 48 hours through the membership card. This would assist you efficiently in meeting the urgent financial needs and then you can repay the loan amount through easy EMIs (Equated Monthly Instalments).</p>

				<p class="text-justify">Prayosha Fincart's Gold Membership Card is a great offering for every loan seeker. Also, one of the great aspects of this membership card is that it does not require any eligibility check, this means that a loan seeker from any place, with any financial background, belonging to any profession, can apply for the membership card and avail of its highly acclaimed benefits. If you are facing any urgency of money, you can opt for a quick personal loan from Prayosha Fincart through its Gold Membership Card. As Prayosha Fincart is partnered with multiple banks and Non-Banking Financial Companies (NBFCs), the loan seeker can get personal loan offers from several banks. Also, even after multiple bank verification, there would not be any impact on the person's CIBIL or credit score.</p>
			</div>
		</div>
	</div>
</section>
