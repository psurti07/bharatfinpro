    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-7 col-12">
                ...
                <p>Our Gold Membership Card provides you with an Instant Personal Loan of up to ₹10 Lakhs plus several
                ...
                <a href="<?php echo site_url('digital/personalLoan'); ?>" class="btn btn-primary"><span>Buy
                        Now</span></a>
            </div>

            <div class="col-lg-5 col-md-5 col-12">
                <img src="<?php echo base_url('assets/images/slider/membership-card-gold.png'); ?>"
                    alt="Gold membership card" class="img-fluid rounded">
            </div>
        </div>
        ...
        <div class="row m-t-40">
            <div class="col-12">
                ...
                <p class="text-justify">Bharatfinpro's Gold Membership Card is an innovative and the most effective way
                    of getting personal loan offers from multiple banks and private financial institutions – in just 48
                    hours! Yes, when you purchase the membership card, apart from getting instant loan offers, you get
                    eligible to avail of certain other amazing services provided by Bharatfinpro.</p>

                <p class="text-justify">A personal loan is a very handy and convenient option when any urgent situation,
                    demanding financial assistance, arises. Bharatfinpro understands it and this is the foundational
                    thought behind the Gold Membership Card. An individual can come across certain situations like –
                    wanting money for medical emergencies, wedding funds, unplanned vacations, home renovation, academic
                    fees, buying your own vehicle, etc. In all such instances of urgent money need, you can easily get a
                    personal loan of up to ₹10 Lakhs in just 48 hours through the membership card. This would assist you
                    efficiently in meeting the urgent financial needs and then you can repay the loan amount through
                    easy EMIs (Equated Monthly Instalments).</p>

                <p class="text-justify">Bharatfinpro's Gold Membership Card is a great offering for every loan seeker.
                    Also, one of the great aspects of this membership card is that it does not require any eligibility
                    check, this means that a loan seeker from any place, with any financial background, belonging to any
                    profession, can apply for the membership card and avail of its highly acclaimed benefits. If you are
                    facing any urgency of money, you can opt for a quick personal loan from Bharatfinpro through its
                    Gold Membership Card. As Bharatfinpro is partnered with multiple banks and Non-Banking Financial
                    Companies (NBFCs), the loan seeker can get personal loan offers from several banks. Also, even after
                    multiple bank verification, there would not be any impact on the person's CIBIL or credit score.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 m-b-20">
                ...
                <p>We believe in helping you with all our efforts! Serving the same purpose, purchasing a membership
                    ...
                    suitable personal loan offers</p>
            </div>

            <div class="col-lg-4 m-b-20">
                <h4>Get 35% Referral Payout as Reward</h4>
                <p>Besides getting personal loan offers from our partnered banks, you can make a good income through
                    easy refer and share, and you can earn up to 35% referral commission from us.</p>
            </div>

            <div class="col-lg-4 m-b-20">
                <h4>Quick Loan Approval</h4>
                <p>You can get a personal loan of up to Rs.10 lakhs in just 48 hours! Our quick services will aid you in
                    getting your personal loan with the quick loan approval. Still, the final timeframe and loan details
            ...
            <div class="col-lg-4 m-b-20">
                ...
                <p>One of the best features of buying the Gold Membership Card is that even after multiple bank
    ...
    <div class="container">
        ...
        <div class="row" data-item="post-item">
            ...
            <div class="post-item border col-md-4 p-2">
                <div class="post-item-wrap">
                    <div class="post-item-description background-grey">
                        <h2>3. Buy Gold Membership Card</h2>
                        <hr>
