				...
				<div class="card border-2 border-secondary shadow-none">
					<div class="card-header background-offer" style="border-radius: 8px 8px 0 0;">
						<div class="card-title">
							<h4 class="font-weight-bold font-italic text-light">Your Personal Loan up to <span class="text-secondary">Rs.5 Lakhs</span> is Ready To Be Processed Ahead!</h4>
						</div>
					</div>
					<div class="card-body sm-m-0">
						...
						<div class="carousel equalize testimonial testimonial-box" data-margin="10" data-arrows="false" data-dots="false" data-items="2" data-items-sm="2" data-items-xxs="1" data-equalize-item=".testimonial-item">
							<?php foreach ($loanoffers as $row) { ?>
								<img src="<?php echo base_url('assets/images/privylege_finance/' . $row); ?>" alt="offer img">
							<?php } ?>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-6 col-md-6 col-12 order-md-2 order-1 center sm-p-0">
				<div class="card border-2 border-secondary shadow-none">
					<div class="card-header background-offer" style="border-radius: 8px 8px 0 0;">
						...
						<?php endif; ?>
						<div class="card-title">
							<p><span class="font-weight-bold text-light">Membership Fees</span> <span class="small font-italic text-light">18% GST additional.</span></p>
							<?php
					...
					<div class="card-body sm-m-0">
						...
						<div class="form-group text-left">
							<button type="submit" id="form-submit1" class="btn btn-block btn-lg btn-process-offer">PROCEED TO PAY</button>
						</div>
...
<section class="background-white pt-1">
	<div class="container">
		...
		<?php $testimoniallist = array('1.jpeg','2.jpeg','3.jpeg'); ?>
