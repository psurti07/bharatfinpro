  ...
  <div class="container-fluid">
    <div class="container-fullscreen">
      <div class="text-middle text-center text-light m-t-80">
        ...
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100px" height="70px" viewBox="0 0 100 68">
            <g id="large">
              <g>
              <path d="M55.777,38.473l6.221-1.133c0.017-1.791-0.123-3.573-0.41-5.324l-6.321-0.19c-0.438-2.053-1.135-4.048-2.076-5.931
                ...
                c-6.244-2.999-8.872-10.493-5.867-16.736c3.002-6.244,10.495-8.873,16.736-5.869C42.676,28.698,45.306,36.19,42.302,42.435z"  fill="none" stroke="#FFF"/>    <animateTransform 
        ...
        <h2 class="text-uppercase text-medium m-t-20">UNDER CONSTRUCTION</h2>
        <p class="lead">Please forgive the inconvenience. We are currently working on this. We will get back to you as soon as possible.</p>
        <a href="<?php echo base_url(); ?>" class="btn btn-light btn-sm">Go to Homepage</a>
      </div>
    </div>
  </div>
</section>
