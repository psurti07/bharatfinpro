...
function user_track_new_ue($postdata) {
    ...
    curl_setopt_array($curl, [
      ...
      CURLOPT_POSTFIELDS => json_encode($postdata),
      CURLOPT_HTTPHEADER => [
        "Authorization: Basic " . INTERAKT_KEY_NEW_UE,
        "Content-Type: application/json"
      ],
    ]);
...
function plan_user_track_ue($postdata) {
    $curl = curl_init();
    ...
    curl_setopt_array($curl, [
      ...
      CURLOPT_POSTFIELDS => json_encode($postdata),
      CURLOPT_HTTPHEADER => [
        "Authorization: Basic " . PLAN_INTERAKT_KEY_NEW_UE,
        "Content-Type: application/json"
      ],
    ]);
...
function plan_event_track_ue($postdata) {
    $curl = curl_init();
